...
public class TestPAdESTriPhaseHTTPStandalone {
	...
	public TestPAdESTriPhaseHTTPStandalone() {

		Client client = Client.create();
		this.resource = client
				.resource("http://localhost:9003/afirma-webapp-pdf/rest/");
	}
	...
	static {
		...
		p1.setProperty("policyIdentifier", "2.16.724.1.3.1.1.2");
		p1.setProperty("policyQualifier", "http://google.com/");
	}
