...
static ber_tlv_tag_t asn_DEF_policyQualifiers_tags_3[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
...
static ber_tlv_tag_t asn_DEF_PolicyInformation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PolicyInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (6 << 2)), 0, 0, 0 }, /* policyIdentifier at 110 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, 0, 0 } /* policyQualifiers at 112 */
};
