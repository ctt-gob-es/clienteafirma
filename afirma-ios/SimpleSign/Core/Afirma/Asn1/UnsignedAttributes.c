...
static asn_TYPE_member_t asn_MBR_UnsignedAttributes_1[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_UnsignedAttributes_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_UnsignedAttributes_specs_1 = {
