...
+ (NSArray *)getAddedCertificatesInfo
{
    ...
    for (CFIndex resultIndex = 0; resultIndex < resultCount; resultIndex++) {
        ...
        PFCertificateInfo *certificateInfoDict = [self getPFCertificateInfoFromCertificate:certificateRef];
...
+ (PFCertificateInfo *)getPFCertificateInfoFromCertificate:(SecCertificateRef)certificateRef
{
