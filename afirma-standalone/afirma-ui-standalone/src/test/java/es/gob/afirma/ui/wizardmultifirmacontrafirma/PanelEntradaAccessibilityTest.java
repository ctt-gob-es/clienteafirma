...
public class PanelEntradaAccessibilityTest {
	 ...
	 * Log.
	 */
	private static Logger logger = Logger.getLogger(PanelEntradaAccessibilityTest.class.getName());
	...
	public void testNotDuplicatedLabelForProperty() {
		...
		try {
			...
			final PanelEntrada panelEntrada = new PanelEntrada( null);
			...
			final Component[] components = panelEntrada.getComponents();
