...
public final class AOCertVerifier {
    ...
    public void checkCertificate(final Certificate[] certChain, final boolean verifyRevocation) throws AOException,
        ...
        if (this.checkValidity || !verifyRevocation) {
            for (final Certificate c : certChain) {
                try {
                    ...
                    this.errorMessage = Messages.getString("AOCertVerifier.0"); //$NON-NLS-1$
                    throw e;
                }
                catch (final CertificateNotYetValidException e) {
                    this.errorMessage = Messages.getString("AOCertVerifier.1"); //$NON-NLS-1$
                    throw e;
                }
                catch (final Exception e) {
                    this.errorMessage = Messages.getString("AOCertVerifier.2"); //$NON-NLS-1$
        ...
        try {
            ...
            this.errorMessage = Messages.getString("AOCertVerifier.3"); //$NON-NLS-1$
            throw new AOException(this.errorMessage, e);
        }
        ...
        try {
            ...
            this.errorMessage = Messages.getString("AOCertVerifier.4"); //$NON-NLS-1$
        ...
        try {
            ...
            this.errorMessage = Messages.getString("AOCertVerifier.5"); //$NON-NLS-1$
        ...
        try {
            ...
            this.errorMessage = Messages.getString("AOCertVerifier.7"); //$NON-NLS-1$
            ...
            if (exceptionClass.getSimpleName().equals("CertificateRevokedException")) { //$NON-NLS-1$
                final AOCertificateRevokedException cre = new AOCertificateRevokedException(Messages.getString("AOCertVerifier.8"), e); //$NON-NLS-1$
                try {
            ...
            this.errorMessage = Messages.getString("AOCertVerifier.6"); //$NON-NLS-1$
