...
final class PanelFinalizar extends JAccessibilityDialogWizard {
    ...
    private void initComponents() {
        ...
        final String textLabel = Messages.getString("Wizard.sobres.final1") + Constants.HTML_SALTO_LINEA + Constants.HTML_SALTO_LINEA + Messages.getString("Wizard.sobres.final.final2");  //$NON-NLS-1$//$NON-NLS-2$
        ...
        // La botonera se introduce en la ventana que crea el asistente
    }
