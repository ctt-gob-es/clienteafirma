...
public final class PsoSignHashApduCommand extends CommandApdu {
	...
	/** Byte para indicar que se trata de una operaci&oacute;n de firma. */
	private static final byte DATA_FIELD_SIGN_OPERATION = (byte) 0x9e;

	/** Byte para indicar que se proporciona un certificado para su verificaci&oacute;n. */
	private static final byte DATA_FIELD_SIGN_HASH = (byte) 0x9a;
