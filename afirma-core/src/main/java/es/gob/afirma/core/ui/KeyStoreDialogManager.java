...
//	int KEYSTORE_ID_PKCS11 = 5;
	 ...
	 * @throws IllegalStateException Cuando ha fallado la inicializaci&oacute;n del almac&eacute;n.
	 */
	...
	/**
	 * Establece el componente padre sobre el que mostrar cualquier di&aacute;logo gr&aacute;fico.
	 * @param parent Componente padre (Component, Window o Frame).
	 */
