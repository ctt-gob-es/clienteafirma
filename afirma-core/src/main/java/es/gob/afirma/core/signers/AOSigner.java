...
public interface AOSigner extends AOCoSigner, AOCounterSigner, AOSimpleSigner {
     ...
     */
    AOTreeModel getSignersStructure(byte[] sign, boolean asSimpleSignInfo) throws AOInvalidSignatureFormatException, IOException;
	 ...
	 * @throws IOException Si ocurren problemas relacionados con la lectura de la firma
	 */
	AOTreeModel getSignersStructure(byte[] sign, Properties params, boolean asSimpleSignInfo) throws AOInvalidSignatureFormatException, IOException;
