...
final class OOXMLUtil {
     ...
     * @param entries Listado de entradas del ZIP.
	 ...
	 * @param zipData Contenido del archivo comprimido.
	...
	/**
	 * Lee una entrada de un documento OOXML.
	 * @param ooxmlData Contenido del documento OOXML.
	 * @param entryName Nombre de la entrada buscada.
