...
public final class AOPDFSigner implements AOSigner, AOConfigurableContext {
	...
	static {
		final String[] providers = new String[] { "SunEC", "BC" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public byte[] sign(final byte[] inPDF,
        ...
        try {
			...
			throw new AOException("Error el en algoritmo de firma: " + e, e, ErrorCode.Request.UNSUPPORTED_SIGNATURE_ALGORITHM); //$NON-NLS-1$
		}
