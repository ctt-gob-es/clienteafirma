...
public final class JSONSingleSignConstants {
	...
	static TriPhasePreProcessor getTriPhasePreProcessor(final JSONSingleSign sSign) throws AOInvalidFormatException {
		if (sSign == null) {
