 ...
 */
public class JSONRequestParameters extends HashMap<String, String> {

	/** Serial Id. */
	private static final long serialVersionUID = 6942017463741129394L;

	private JSONRequestParameters() {
		super();
	}
	 ...
	 */
	public static JSONRequestParameters extractParameters(final HttpServletRequest request) throws IOException {

		final JSONRequestParameters params = new JSONRequestParameters();
	...
	private static void extractParametersFromUrl(final HttpServletRequest request, final JSONRequestParameters params) {
	...
	private static void extractParametersFromBody(final HttpServletRequest request, final JSONRequestParameters params) throws IOException {
