...
package es.gob.afirma.triphase.server.batch.json;
...
import es.gob.afirma.triphase.server.batch.BatchException;
import es.gob.afirma.triphase.server.batch.ProcessResult;
import es.gob.afirma.triphase.server.batch.SingleSignConstants;
import es.gob.afirma.triphase.server.batch.TempStore;
import es.gob.afirma.triphase.server.batch.TempStoreFactory;
import es.gob.afirma.triphase.server.batch.ProcessResult.Result;
