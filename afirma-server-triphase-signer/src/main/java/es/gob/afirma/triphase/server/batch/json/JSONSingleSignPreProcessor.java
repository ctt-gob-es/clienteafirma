...
import es.gob.afirma.triphase.server.batch.BatchServiceErrorCode;
import es.gob.afirma.triphase.server.batch.LegacyFunctions;
import es.gob.afirma.triphase.server.batch.SingleSignConstants;
import es.gob.afirma.triphase.server.batch.TriPhaseHelper;
import es.gob.afirma.triphase.server.batch.SingleSignConstants.SignSubOperation;
