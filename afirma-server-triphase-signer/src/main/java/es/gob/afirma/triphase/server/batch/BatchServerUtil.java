...
package es.gob.afirma.triphase.server.batch;
...
import es.gob.afirma.triphase.server.batch.json.TriphaseDataParser;

public final class BatchServerUtil {
	...
	public static TriphaseData getTriphaseDataFromJSON(final byte[] triphaseDataAsUrlSafeBase64) throws IOException {
		return TriphaseDataParser.parseFromJSON(
			Base64.decode(triphaseDataAsUrlSafeBase64, 0, triphaseDataAsUrlSafeBase64.length, true)
		);
	}

	public static X509Certificate[] getCertificates(final String certListUrlSafeBase64) throws CertificateException,
	                                                                                    IOException {
