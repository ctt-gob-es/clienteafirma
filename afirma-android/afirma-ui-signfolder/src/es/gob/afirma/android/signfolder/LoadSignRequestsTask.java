 ...
 */
public class LoadSignRequestsTask extends AsyncTask<Void, Void, PartialSignRequestsList> {
	 ...
	 */
	public LoadSignRequestsTask(final String certEncodedB64, final String state, final int numPage, final int pageSize, final List<String> filters, final CommManager commManager, final LoadSignRequestListener listener) {
    ...
    interface LoadSignRequestListener {
    	 ...
    	 */
    	public void loadedSignRequest(List<SignRequest> signRequests, int pageNumber, int numPages);
