...
public class PolicyInformation {
     ...
     */
    public PolicyInformation(final CertificatePolicyId policyIdentifier,
            final Set<PolicyQualifierInfo> policyQualifiers) throws IOException {
     ...
     * @exception IOException on decoding errors.
     */
    public PolicyInformation(final DerValue val) throws IOException {
        ...
        if (val.data.available() != 0) {
            ...
            while (opt.data.available() != 0) {
				this.policyQualifiers.add(new PolicyQualifierInfo
	...
	public boolean equals(final Object other) {
        ...
        final PolicyInformation piOther = (PolicyInformation)other;
    ...
    public void set(final String name, final Object obj) throws IOException {
        if (name.equalsIgnoreCase(ID)) {
            ...
            if (obj instanceof Set) {
                final Iterator<?> i = ((Set<?>)obj).iterator();
                while (i.hasNext()) {
                ...
                this.policyQualifiers = (Set<PolicyQualifierInfo>) obj;
            } else {
	...
	public String toString() {
        final StringBuilder s = new StringBuilder("  [" + this.policyIdentifier.toString());
        s.append(this.policyQualifiers + "  ]\n");
        return s.toString();
    }
    ...
    public void encode(final DerOutputStream out) throws IOException {
        ...
        if (!this.policyQualifiers.isEmpty()) {
            ...
            for (final PolicyQualifierInfo pq : this.policyQualifiers) {
