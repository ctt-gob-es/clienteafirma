...
public class DerInputStream {
     ...
     */
    private void init(final byte[] data, final int offset, final int len) throws IOException {
    ...
    public BitArray getUnalignedBitString() throws IOException {
         ...
         * representation.
         */
        final int validBits = length*8 - this.buffer.read();
    ...
    protected DerValue[] readVector(final int startLen) throws IOException {
        ...
        int len = getLength((lenByte & 0xff), this.buffer);
         ...
         */
        final Vector<DerValue> vec = new Vector<DerValue>(startLen);
        DerValue value;
