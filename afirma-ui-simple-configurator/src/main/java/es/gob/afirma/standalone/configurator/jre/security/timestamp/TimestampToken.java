...
public class TimestampToken {
     ...
     */
    public TimestampToken(final byte[] timestampTokenInfo) throws IOException {
     ...
     *         while parsing.
     */
    private void parse(final byte[] timestampTokenInfo) throws IOException {

        final DerValue tstInfo = new DerValue(timestampTokenInfo);
        ...
        while (tstInfo.data.available() > 0) {
            final DerValue d = tstInfo.data.getDerValue();
