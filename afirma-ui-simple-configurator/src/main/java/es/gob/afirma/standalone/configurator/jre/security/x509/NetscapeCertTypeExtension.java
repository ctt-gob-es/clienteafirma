...
implements CertAttrSet<String> {
    ...
    private static class MapEntry {
        ...
        MapEntry(final String name, final int position) {
            this.mName = name;
    ...
    static {
        for (final MapEntry entry : mMapData) {
            mAttributeNames.add(entry.mName);
        }
    }

    private static int getPosition(final String name) throws IOException {
        for (final MapEntry element : mMapData) {
            if (name.equalsIgnoreCase(element.mName)) {
     ...
     */
    public NetscapeCertTypeExtension(final byte[] bitString) throws IOException {
        this.bitString =
     ...
     */
    public NetscapeCertTypeExtension(final Boolean critical, final Object value)
    throws IOException {
        this.extensionId = NetscapeCertType_Id;
     ...
     */
    @Override
	public Boolean get(final String name) throws IOException {
    ...
    public boolean[] getKeyUsageMappedBits() {
        final KeyUsageExtension keyUsage = new KeyUsageExtension();
