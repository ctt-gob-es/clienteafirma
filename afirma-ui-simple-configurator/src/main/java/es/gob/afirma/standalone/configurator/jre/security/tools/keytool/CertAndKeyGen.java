...
package es.gob.afirma.standalone.configurator.jre.security.tools.keytool;
...
import es.gob.afirma.standalone.configurator.jre.security.pkcs10.PKCS10;
import es.gob.afirma.standalone.configurator.jre.security.x509.AlgorithmId;
import es.gob.afirma.standalone.configurator.jre.security.x509.CertificateAlgorithmId;
import es.gob.afirma.standalone.configurator.jre.security.x509.CertificateExtensions;
import es.gob.afirma.standalone.configurator.jre.security.x509.CertificateSerialNumber;
import es.gob.afirma.standalone.configurator.jre.security.x509.CertificateValidity;
import es.gob.afirma.standalone.configurator.jre.security.x509.CertificateVersion;
import es.gob.afirma.standalone.configurator.jre.security.x509.CertificateX509Key;
...
public final class CertAndKeyGen {
     ...
     */
    public CertAndKeyGen (final String keyType, final String sigAlg)
     ...
     */
    public CertAndKeyGen (final String keyType, final String sigAlg, final String providerName)
     ...
     */
    public void         setRandom (final SecureRandom generator)
    {
        this.prng = generator;
    }
     ...
     */
    public void generate (final int keyBits)
    ...
    public X509Certificate getSelfCertificate (
            final X500Name myname, final Date firstDate, final long validity)
    ...
    public X509Certificate getSelfCertificate (final X500Name myname, final Date firstDate,
            final long validity, final CertificateExtensions ext)
    throws CertificateException, InvalidKeyException, SignatureException,
        NoSuchAlgorithmException, NoSuchProviderException
    {
        X509CertImpl    cert;
        ...
        try {
            ...
            final AlgorithmId algID = AlgorithmId.get(this.sigAlg);
    ...
    // Keep the old method
    public X509Certificate getSelfCertificate (final X500Name myname, final long validity)
    throws CertificateException, InvalidKeyException, SignatureException,
        NoSuchAlgorithmException, NoSuchProviderException
    {
     ...
     * @exception SignatureException on signature handling errors.
     */
    public PKCS10 getCertRequest (final X500Name myname)
    throws InvalidKeyException, SignatureException
    {
        final PKCS10  req = new PKCS10 (this.publicKey);

        try {
            final Signature signature = Signature.getInstance(this.sigAlg);
