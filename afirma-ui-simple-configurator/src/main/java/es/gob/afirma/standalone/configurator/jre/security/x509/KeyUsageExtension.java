...
implements CertAttrSet<String> {
     ...
     */
    public KeyUsageExtension(final byte[] bitString) throws IOException {
        this.bitString =
     ...
     * @param bitString the bits to be set for the extension.
     */
    public KeyUsageExtension(final BitArray bitString) throws IOException {
     ...
     */
    public KeyUsageExtension(final Boolean critical, final Object value)
    throws IOException {
        this.extensionId = PKIXExtensions.KeyUsage_Id;
         ...
         * }
         */
        final byte[] extValue = (byte[]) value;
