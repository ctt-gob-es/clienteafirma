...
implements CertAttrSet<String> {
     ...
     */
    public BasicConstraintsExtension(final boolean ca, final int len) throws IOException {
     ...
     * @param len specifies the depth of the certification path.
     */
    public BasicConstraintsExtension(final Boolean critical, final boolean ca, final int len)
    throws IOException {
        this.ca = ca;
        this.pathLen = len;
     ...
     */
     public BasicConstraintsExtension(final Boolean critical, final Object value)
         throws IOException
    {
         this.extensionId = PKIXExtensions.BasicConstraints_Id;
         this.critical = critical.booleanValue();
	...
	public String toString() {
         ...
         s += ((this.ca) ? ("  CA:true") : ("  CA:false")) + "\n";
         if (this.pathLen >= 0) {
             s += "  PathLen:" + this.pathLen + "\n";
         } else {
             s += "  PathLen: undefined\n";
         }
         return (s + "]\n");
