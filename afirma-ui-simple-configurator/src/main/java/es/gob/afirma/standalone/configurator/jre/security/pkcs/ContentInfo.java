...
public class ContentInfo {
     ...
     */
    public ContentInfo(final byte[] bytes) {
        final DerValue octetString = new DerValue(DerValue.tag_OctetString, bytes);
     ...
     */
    public ContentInfo(final DerInputStream derin)
     ...
     */
    public ContentInfo(final DerInputStream derin, final boolean oldStyle)
        throws IOException, ParsingException
    {
    ...
    public byte[] getData() throws IOException {
        if (this.contentType.equals((Object)DATA_OID) ||
            this.contentType.equals((Object)OLD_DATA_OID) ||
            this.contentType.equals((Object)TIMESTAMP_TOKEN_INFO_OID)) {
    ...
    public byte[] getContentBytes() throws IOException {
        ...
        final DerInputStream dis = new DerInputStream(this.content.toByteArray());
