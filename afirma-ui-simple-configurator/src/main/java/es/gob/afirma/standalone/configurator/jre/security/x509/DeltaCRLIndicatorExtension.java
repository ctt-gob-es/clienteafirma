...
public class DeltaCRLIndicatorExtension extends CRLNumberExtension {
     ...
     */
    public DeltaCRLIndicatorExtension(final int crlNum) throws IOException {
     ...
     * @param crlNum the value to be set for the extension.
     */
    public DeltaCRLIndicatorExtension(final BigInteger crlNum) throws IOException {
     ...
     */
    public DeltaCRLIndicatorExtension(final Boolean critical, final Object value)
    throws IOException {
