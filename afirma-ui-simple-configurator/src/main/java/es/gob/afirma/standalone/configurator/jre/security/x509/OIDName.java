...
public class OIDName implements GeneralNameInterface {
     ...
     */
    public OIDName(final String name) throws IOException {
        try {
            this.oid = new ObjectIdentifier(name);
        } catch (final Exception e) {
            throw new IOException("Unable to create OIDName: " + e); //$NON-NLS-1$
        }
    }
	...
	public String toString() {
        return ("OIDName: " + this.oid.toString()); //$NON-NLS-1$
    }
	...
	public boolean equals(final Object obj) {
        ...
        final OIDName other = (OIDName)obj;
	...
	public int constrains(final GeneralNameInterface inputName) throws UnsupportedOperationException {
        ...
        if (inputName == null) {
            ...
            throw new UnsupportedOperationException("Narrowing and widening are not supported for OIDNames"); //$NON-NLS-1$
		}
	...
	public int subtreeDepth() throws UnsupportedOperationException {
        throw new UnsupportedOperationException("subtreeDepth() not supported for OIDName."); //$NON-NLS-1$
   }
}
