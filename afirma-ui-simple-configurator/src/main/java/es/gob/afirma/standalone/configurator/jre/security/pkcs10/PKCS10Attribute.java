...
public class PKCS10Attribute implements DerEncoder {
     ...
     */
    public PKCS10Attribute(final DerValue derVal) throws IOException {
        final PKCS9Attribute attr = new PKCS9Attribute(derVal);
     ...
     */
    public PKCS10Attribute(final ObjectIdentifier attributeId,
     ...
     */
    public PKCS10Attribute(final PKCS9Attribute attr) {
        this.attributeId = attr.getOID();
        this.attributeValue = attr.getValue();
    }
	...
	public void derEncode(final OutputStream out) throws IOException {
        final PKCS9Attribute attr = new PKCS9Attribute(this.attributeId, this.attributeValue);
        attr.derEncode(out);
    }
