...
public class BitArray {
    ...
    public BitArray(final int length) throws IllegalArgumentException {
        if (length < 0) {
            throw new IllegalArgumentException("Negative length for BitArray"); //$NON-NLS-1$
        }
    ...
    public BitArray(final int length, final byte[] a) throws IllegalArgumentException {
        ...
        if (a.length * BITS_PER_UNIT < length) {
            throw new IllegalArgumentException("Byte array too short to represent " + //$NON-NLS-1$
                                               "bit array of given length"); //$NON-NLS-1$
        }
	...
	public int hashCode() {
        ...
        for (final byte element : this.repn) {
