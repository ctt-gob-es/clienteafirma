...
public class CertificatePolicyMap {
     ...
     */
    public CertificatePolicyMap(final CertificatePolicyId issuer,
                                final CertificatePolicyId subject) {
     ...
     */
    public CertificatePolicyMap(final DerValue val) throws IOException {
        if (val.tag != DerValue.tag_Sequence) {
            throw new IOException("Invalid encoding for CertificatePolicyMap"); //$NON-NLS-1$
        }
	...
	public String toString() {
        final String s = "CertificatePolicyMap: [\n" //$NON-NLS-1$
                 + "IssuerDomain:" + this.issuerDomain.toString() //$NON-NLS-1$
                 + "SubjectDomain:" + this.subjectDomain.toString() //$NON-NLS-1$
                 + "]\n"; //$NON-NLS-1$
