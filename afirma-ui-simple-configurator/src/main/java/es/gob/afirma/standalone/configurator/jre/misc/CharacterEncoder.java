...
public abstract class CharacterEncoder {
     ...
     */
    protected void encodeBufferPrefix(final OutputStream aStream) throws IOException {
     ...
     */
    protected void encodeBufferSuffix(final OutputStream aStream) throws IOException {
    }

    /**
     * Encode the prefix that starts every output line.
     */
    protected void encodeLinePrefix(final OutputStream aStream, final int aLength)
    throws IOException {
    }
     ...
     */
    protected void encodeLineSuffix(final OutputStream aStream) throws IOException {
     ...
     */
    public void encode(final byte aBuffer[], final OutputStream aStream)
    throws IOException {
     ...
     * The ByteBuffer's position will be advanced to ByteBuffer's limit.
     */
    public void encode(final ByteBuffer aBuffer, final OutputStream aStream)
        throws IOException {
     ...
     * The ByteBuffer's position will be advanced to ByteBuffer's limit.
     */
    public String encodeBuffer(final ByteBuffer aBuffer) {
        final byte [] buf = getBytes(aBuffer);
