...
public class CalendarUtils {
     ...
     */
    public static final boolean isGregorianLeapYear(final int gregorianYear) {
     ...
     * @see CalendarDate#isLeapYear
     */
    public static final boolean isJulianLeapYear(final int normalizedJulianYear) {
     ...
     */
    public static final long floorDivide(final long n, final long d) {
        return ((n >= 0) ?
                (n / d) : (((n + 1L) / d) - 1L));
    }
     ...
     * @return the floor of the quotient
     */
    public static final int floorDivide(final int n, final int d) {
        return ((n >= 0) ?
                (n / d) : (((n + 1) / d) - 1));
    }
     ...
     * @return the floor of the quotient.
     */
    public static final int floorDivide(final int n, final int d, final int[] r) {
        if (n >= 0) {
            r[0] = n % d;
            return n / d;
        }
     ...
     * @return the floor of the quotient.
     */
    public static final int floorDivide(final long n, final int d, final int[] r) {
        if (n >= 0) {
            r[0] = (int)(n % d);
            return (int)(n / d);
        }
        final int q = (int)(((n + 1) / d) - 1);
        r[0] = (int)(n - (q * d));
        return q;
    }

    public static final long mod(final long x, final long y) {
        return (x - y * floorDivide(x, y));
    }

    public static final int mod(final int x, final int y) {
        return (x - y * floorDivide(x, y));
    }

    public static final int amod(final int x, final int y) {
        final int z = mod(x, y);
        return (z == 0) ? y : z;
    }

    public static final long amod(final long x, final long y) {
        final long z = mod(x, y);
        return (z == 0) ? y : z;
    }
     ...
     */
    public static final StringBuilder sprintf0d(final StringBuilder sb, final int value, int width) {
        long d = value;
        if (d < 0) {
            sb.append('-');
            d = -d;
    ...
    public static final StringBuffer sprintf0d(final StringBuffer sb, final int value, int width) {
        long d = value;
        if (d < 0) {
            sb.append('-');
            d = -d;
