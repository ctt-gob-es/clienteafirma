...
public class PanelPresentacion extends JAccessibilityDialogWizard {
    ...
    private void initComponents() {
        ...
        panelCentral.add(
        		PanelesTexto.generarPanelTexto("Wizard.sobres.presentacion1", true), c);
    	
        // Panel con el texto "Los sobres digitales..."
        panelCentral.add(
        		PanelesTexto.generarPanelTexto("Wizard.sobres.presentacion2", true), c);
        
        // Panel con el texto "El remitente puede..."
        panelCentral.add(
        		PanelesTexto.generarPanelTexto("Wizard.sobres.presentacion3", true), c);
        
        // Panel con el texto "Recuerde que las..."
        panelCentral.add(
        		PanelesTexto.generarPanelTexto("Wizard.sobres.presentacion4", true), c);
        
        c.weighty = 1.0;
        
        // Panel con el texto "A lo largo de este..."
        panelCentral.add(
        		PanelesTexto.generarPanelTexto("Wizard.sobres.presentacion5", true), c);
