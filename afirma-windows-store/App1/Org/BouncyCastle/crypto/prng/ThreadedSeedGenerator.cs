	...
	public class ThreadedSeedGenerator
	{
		private class SeedGenerator
		{
				...
				bool	fast)
			{
                ...
                //TODO: COMENTADO. NO SE PUEDE USAR "QueueUserWorkItem"
                //ThreadPool.QueueUserWorkItem(new WaitCallback(Run));
                
                IAsyncAction ThreadPoolWorkItem = Windows.System.Threading.ThreadPool.RunAsync(Run);
				...
				for (int i = 0; i < end; i++)
				{
					while (this.counter == last)
					{
						try
						{
                            //TODO: COMENTADO. NO SE PUEDE USAR "Thread.Sleep"
							//Thread.Sleep(1);
                            Worker w = new Worker();
                            w.DoWorkAsync();
						}
