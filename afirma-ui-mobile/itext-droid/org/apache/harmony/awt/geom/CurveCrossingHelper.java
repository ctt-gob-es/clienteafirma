...
public class CurveCrossingHelper {
		...
		for (int i = 0; i < rulesSizes[0]; i++) {
			...
			for (int j = 0; j < rulesSizes[1]; j++) {
				...
				if (((rule1 == PathIterator.SEG_LINETO) || (rule1 == PathIterator.SEG_CLOSE))
					...
					ipCount = GeometryUtil.intersectLinesWithParams(edge1[0], edge1[1], edge1[2], edge1[3], edge2[0],
							edge2[1], edge2[2], edge2[3], params);
					...
					ipCount = GeometryUtil.intersectLineAndQuad(edge1[0], edge1[1], edge1[2], edge1[3], edge2[0],
							edge2[1], edge2[2], edge2[3], edge2[4], edge2[5], params);
					for (int k = 0; k < ipCount; k++) {
						...
						&& (rule2 == PathIterator.SEG_LINETO || rule2 == PathIterator.SEG_CLOSE)) {
					ipCount = GeometryUtil.intersectLineAndQuad(edge2[0], edge2[1], edge2[2], edge2[3], edge1[0],
							edge1[1], edge1[2], edge1[3], edge1[4], edge1[5], params);
					for (int k = 0; k < ipCount; k++) {
						...
						&& ((rule2 == PathIterator.SEG_LINETO) || (rule2 == PathIterator.SEG_CLOSE))) {
					ipCount = GeometryUtil.intersectLineAndCubic(edge1[0], edge1[1], edge1[2], edge1[3], edge1[4],
							edge1[5], edge1[6], edge1[7], edge2[0], edge2[1], edge2[2], edge2[3], params);
					...
					ipCount = GeometryUtil.intersectLineAndCubic(edge1[0], edge1[1], edge1[2], edge1[3], edge2[0],
							edge2[1], edge2[2], edge2[3], edge2[4], edge2[5], edge2[6], edge2[7], params);
					...
					ipCount = GeometryUtil.intersectQuads(edge1[0], edge1[1], edge1[2], edge1[3], edge1[4], edge1[5],
					...
					ipCount = GeometryUtil.intersectQuadAndCubic(edge1[0], edge1[1], edge1[2], edge1[3], edge1[4],
							edge1[5], edge2[0], edge2[1], edge2[2], edge2[3], edge2[4], edge2[5], edge2[6], edge2[7],
							params);
					...
					ipCount = GeometryUtil.intersectQuadAndCubic(edge2[0], edge2[1], edge2[2], edge2[3], edge2[4],
							edge2[5], edge1[0], edge1[1], edge1[2], edge1[3], edge1[4], edge1[5], edge2[6], edge2[7],
							params);
					...
					ipCount = GeometryUtil.intersectCubics(edge1[0], edge1[1], edge1[2], edge1[3], edge1[4], edge1[5],
							edge1[6], edge1[7], edge2[0], edge2[1], edge2[2], edge2[3], edge2[4], edge2[5], edge2[6],
							edge2[7], params);
				...
				for (int k = 0; k < ipCount; k++) {
					...
					if (!containsPoint(points[2 * k], points[2 * k + 1])) {
						...
						isectPoints.add(new IntersectPoint(begIndex1, endIndex1, rule1, i, begIndex2, endIndex2, rule2,
								j, points[2 * k], points[2 * k + 1], params[2 * k], params[2 * k + 1]));
					}
				}
			}
		}
	...
	private boolean containsPoint(double x, double y) {
		...
		for (Iterator<IntersectPoint> i = isectPoints.iterator(); i.hasNext();) {
			...
			if ((Math.abs(ipoint.getX() - x) < Math.pow(10, -6)) && (Math.abs(ipoint.getY() - y) < Math.pow(10, -6))) {
				return true;
			}
		}
