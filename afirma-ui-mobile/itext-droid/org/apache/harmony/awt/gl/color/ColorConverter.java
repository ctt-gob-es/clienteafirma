...
/**
 * This class combines ColorScaler, ICC_Transform and NativeImageFormat
...
public class ColorConverter {
	...
	/**
	 * Translates pixels, stored in source buffered image and writes the data to
	...
	/**
	 * Translates pixels, stored in the float data buffer. Each pixel occupies
	 * separate array. Input pixels passed in the buffer are replaced by output
	...
	/**
	 * Translates pixels stored in a raster. All data types are supported
	 * 
	 * @param t
	 *            - ICC transform
	 * @param src
	 ...
	 *            - destination pixels
	 */
	// public void translateColor(ICC_Transform t, Raster src, WritableRaster
	// dst) {
	// try{
	// NativeImageFormat srcFmt =
	// NativeImageFormat.createNativeImageFormat(src);
	// NativeImageFormat dstFmt =
	// NativeImageFormat.createNativeImageFormat(dst);
	//
	...
	/**
	 * Translates pixels stored in an array of shorts. Samples are stored
	 * one-by-one, i.e. array structure is like following: RGBRGBRGB... The
	 ...
	 *            - transform
	 * @param arr
	 *            - short array or null if nCols is positive
	 * @param nCols
	 *            - number of pixels in the array or 0 if array is not null
	 * @param in
	 *            - is it an input or output array
