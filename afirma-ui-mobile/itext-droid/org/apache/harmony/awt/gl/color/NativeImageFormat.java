...
class NativeImageFormat {
	...
	private static final int INT_RGB_LCMS_FMT = colorspaceSh(PT_RGB) | extraSh(1) | channelsSh(3) | bytesSh(1)
			| doswapSh(1) | swapfirstSh(1);

	private static final int INT_ARGB_LCMS_FMT = INT_RGB_LCMS_FMT;

	private static final int INT_BGR_LCMS_FMT = colorspaceSh(PT_RGB) | extraSh(1) | channelsSh(3) | bytesSh(1);

	private static final int THREE_BYTE_BGR_LCMS_FMT = colorspaceSh(PT_RGB) | channelsSh(3) | bytesSh(1) | doswapSh(1);

	private static final int FOUR_BYTE_ABGR_LCMS_FMT = colorspaceSh(PT_RGB) | extraSh(1) | channelsSh(3) | bytesSh(1)
			| doswapSh(1);

	private static final int BYTE_GRAY_LCMS_FMT = colorspaceSh(PT_GRAY) | channelsSh(1) | bytesSh(1);

	private static final int USHORT_GRAY_LCMS_FMT = colorspaceSh(PT_GRAY) | channelsSh(1) | bytesSh(2);
	 ...
	 *            - sample model
	 * @param hasAlpha
	 *            - true if there's an alpha channel
	 * @return LCMS format
	 */
	// private static int getFormatFromComponentModel(ComponentSampleModel sm,
	// boolean hasAlpha) {
	 ...
	 */
	// private static int
	// getFormatFromSPPSampleModel(SinglePixelPackedSampleModel sm,
	// boolean hasAlpha) {
	...
	// AwtImageBackdoorAccessor dbAccess =
	// AwtImageBackdoorAccessor.getInstance();
	// try {
	 ...
	 */
	// private static int calculateScanlineStrideCSM(ComponentSampleModel csm,
	// Raster r) {
	 ...
	 */
	// private static int
	// calculateScanlineStrideSPPSM(SinglePixelPackedSampleModel sppsm, Raster
	// r) {
