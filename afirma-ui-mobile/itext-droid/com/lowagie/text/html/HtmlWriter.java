 ...
 * <P>
 * An <CODE>HtmlWriter</CODE> can be added as a <CODE>DocListener</CODE> to a
 * certain <CODE>Document</CODE> by getting an instance. Every
 * <CODE>Element</CODE> added to the original <CODE>Document</CODE> will be
 * written to the <CODE>OutputStream</CODE> of this <CODE>HtmlWriter</CODE>.
 * <P>
 * Example: <BLOCKQUOTE>
 * 
 * <PRE>
 ...
 *    <STRONG>HtmlWriter.getInstance(document, new FileOutputStream(Environment.getExternalStorageDirectory() + File.separator + "droidtext" + File.separator + "text.html"));</STRONG>
...
public class HtmlWriter extends DocWriter {
	 ...
	 * @param os
	 *            The <CODE>OutputStream</CODE> the writer has to write to.
	 */
	 ...
	 * 
	 * @param document
	 *            The <CODE>Document</CODE> that has to be written
	 * @param os
	 *            The <CODE>OutputStream</CODE> the writer has to write to.
	 ...
	 * 
	 * @return <CODE>true</CODE> if this action succeeded, <CODE>false</CODE> if
	 *         not.
	 */
	...
	/**
	 * Signals that an <CODE>Element</CODE> was added to the
	 * <CODE>Document</CODE>.
	 * 
	 * @param element
	...
	protected void initFooter() {
		if (footer != null) {
			try {
				// Set the page number. HTML has no notion of a page, so it
				// should always
				// add up to 1
	 ...
	 * <P>
	 * This is especially useful if you add images using a file, rather than an
	 * URL. In PDF there is no problem, since the images are added inline, but
	 * in HTML it is sometimes necessary to use a relative path or a special
	 * path to some images directory.
	 * 
	 * @param imagepath
	 *            the new imagepath
	 */
	 ...
	 * @return <CODE>true</CODE> if the string was added, <CODE>false</CODE> if
	 *         not.
	 */
