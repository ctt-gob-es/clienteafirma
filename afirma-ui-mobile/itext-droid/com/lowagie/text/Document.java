 ...
 *   PdfWriter.getInstance(<STRONG>document </STRONG>, new FileOutputStream(Environment.getExternalStorageDirectory() + File.separator + "droidtext" + File.separator + "text.pdf"));
