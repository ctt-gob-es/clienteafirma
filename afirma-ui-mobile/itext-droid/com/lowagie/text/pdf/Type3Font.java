...
public class Type3Font extends BaseFont {
	 ...
	 *            the writer
	 * @param chars
	 *            an array of chars corresponding to the glyphs used (not used,
	 *            present for compatibility only)
	 * @param colorized
	 *            if <CODE>true</CODE> the font may specify color, if
	 *            <CODE>false</CODE> no color commands are allowed and only
	 *            images as masks can be used
	 */
	 ...
	 * PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(Environment.getExternalStorageDirectory() + File.separator + "droidtext" + File.separator + &quot;type3.pdf&quot;));
	 * document.open();
	...
	/**
	 * Defines a glyph. If the character was already defined it will return the
	 * same content
	 * 
	 * @param c
	 ...
	 * @param llx
	 *            the X lower left corner of the glyph bounding box. If the
	 *            <CODE>colorize</CODE> option is <CODE>true</CODE> the value is
	 *            ignored
	 * @param lly
	 *            the Y lower left corner of the glyph bounding box. If the
	 *            <CODE>colorize</CODE> option is <CODE>true</CODE> the value is
	 *            ignored
	 * @param urx
	 *            the X upper right corner of the glyph bounding box. If the
	 *            <CODE>colorize</CODE> option is <CODE>true</CODE> the value is
	 *            ignored
	 * @param ury
	 *            the Y upper right corner of the glyph bounding box. If the
	 *            <CODE>colorize</CODE> option is <CODE>true</CODE> the value is
	 *            ignored
	...
	/**
	 * Always returns null, because you can't get the FontStream of a Type3
	 * font.
	 * 
	 * @return null
	 * @since 2.1.3
