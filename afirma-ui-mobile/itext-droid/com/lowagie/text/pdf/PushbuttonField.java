...
public class PushbuttonField extends BaseField {
	...
	/**
	 * Sets the icon and label layout. Possible values are
	 * <CODE>LAYOUT_LABEL_ONLY</CODE>, <CODE>LAYOUT_ICON_ONLY</CODE>,
	 * <CODE>LAYOUT_ICON_TOP_LABEL_BOTTOM</CODE>,
	 * <CODE>LAYOUT_LABEL_TOP_ICON_BOTTOM</CODE>,
	 * <CODE>LAYOUT_ICON_LEFT_LABEL_RIGHT</CODE>,
	...
	/**
	 * A number between 0 and 1 indicating the fraction of leftover space to
	...
	public PdfAppearance getAppearance() throws IOException, DocumentException {
		...
		if (haveIcon) {
			...
			float ypos = iconBox.getBottom() + (iconBox.getHeight() - (boundingBoxHeight * icy))
			...
			if (tp != null)
				...
				app
						.addTemplateReference(iconReference, PdfName.FRM, icx, 0, 0, icy, xpos - cox * icx, ypos - coy
								* icy);
			}
			app.restoreState();
		}
