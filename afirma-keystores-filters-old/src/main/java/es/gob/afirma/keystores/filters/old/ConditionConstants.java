...
interface ConditionConstants {
      ...
      String COMPLEX_CONDITION_PATTERN = COMPOUND_CONDITION_PATTERN + "(" + NEXO_PATTERN + COMPOUND_CONDITION_PATTERN + ")*"; //$NON-NLS-1$ //$NON-NLS-2$

     // Pattern COMPILED_COMPLEX_CONDITION_PATTERN = Pattern.compile(COMPLEX_CONDITION_PATTERN);

      Pattern COMPILED_COMPOUND_CONDITION_PATTERN = Pattern.compile(COMPOUND_CONDITION_PATTERN);

      Pattern COMPILED_SIMPLE_CONDITION_PATERN = Pattern.compile(SIMPLE_CONDITION_PATTERN);
      ...
      HexHelper HEX_HELPER = HexHelper.getInstance();
