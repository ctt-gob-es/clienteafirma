...
/**
 * <code>sun.security.mscapi.KeyStore</code> modificada para acceder a los almacenes de CAPI <i>ADDRESSBOOK</i>
 * y <i>CA</i>.
...
public abstract class KeyStoreAddressBook extends KeyStoreSpi {
    ...
    public static final class ADDRESSBOOK extends KeyStoreAddressBook {
		/** Construye el <code>SPI</code> del KeyStore <i>ADDRESSBOOK</i> de CAPI. */
		public ADDRESSBOOK() {
		    super("ADDRESSBOOK");
		}
    }
