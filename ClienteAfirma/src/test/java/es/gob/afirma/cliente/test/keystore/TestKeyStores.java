...
public final class TestKeyStores {
	...
	public void testP12KeyStore() {
		...
		try {
			ksm = AOKeyStoreManagerFactory.getAOKeyStoreManager(
				...
				libName,
				null,
				new CachePasswordCallback(new char[] { '1', '2', '3', '4', '1', '2', '3', '4' }),
				null
			);
		}
		catch(final Throwable e) {
	...
	public void testCapiAddressBookKeyStore() {
		...
		try {
			ksm = AOKeyStoreManagerFactory.getAOKeyStoreManager(
				AOConstants.AOKeyStore.WINADDRESSBOOK,
				null,
				null,
				null,
				null
	...
	public void testCapiRootKeyStore() {
		...
		try {
			ksm = AOKeyStoreManagerFactory.getAOKeyStoreManager(
				AOConstants.AOKeyStore.WINROOT,
				null,
				null,
				null,
				null
	...
	public void testJksKeyStore() {
		...
		try {
			ksm = AOKeyStoreManagerFactory.getAOKeyStoreManager(
				AOConstants.AOKeyStore.JAVA,
				libName,
				null,
				new CachePasswordCallback(new char[] { 'p', 's', 's', '1', '1', '1', '1' }),
				null
			);
		}
		catch(final Throwable e) {
