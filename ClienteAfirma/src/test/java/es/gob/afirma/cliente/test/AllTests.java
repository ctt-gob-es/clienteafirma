...
@RunWith(Suite.class)
@Suite.SuiteClasses({ TestCipher.class, TestKeyStores.class, TestCAdES.class,
		TestCMS.class, TestODF.class, TestOOXML.class, TestPDF.class,
		TestXAdES.class, TestXMLDSig.class })
