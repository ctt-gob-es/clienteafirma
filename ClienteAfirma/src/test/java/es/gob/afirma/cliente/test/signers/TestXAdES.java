			...
			for (byte[] content : TEST_CONTENT) {
				for (String algo : ALGOS) {
					for (Properties extraParams : XADES_MODES) {
						...
						System.out.print(
							"Prueba con '" + algo + "', '" + kstore + "', formato '" + extraParams.getProperty("format") + "' y contenido "
						);
						...
						if (AOConstants.SIGN_FORMAT_XADES_ENVELOPED.equals(extraParams.getProperty("format")) &&
