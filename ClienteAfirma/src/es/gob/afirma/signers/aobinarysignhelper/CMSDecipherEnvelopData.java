...
public final class CMSDecipherEnvelopData {
     ...
     *
     * @param cmsData           Flujo de lectura de los datos que contienen el tipo EnvelopedData
     ...
     */
	public byte[] dechiperEnvelopData(byte[] cmsData, PrivateKeyEntry keyEntry) throws IOException, CertificateEncodingException, AOException, AOInvalidRecipientException, InvalidKeyException {
        ...
        try {
            ...
            ASN1Sequence contentEnvelopedData = Utils.fetchWrappedData(cmsData);
