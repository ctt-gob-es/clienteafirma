...
/**
 * Clase base para la implementaci&oacute;n del tipo DigestedData en CADES basado
 * en CMS.
...
public final class CADESDigestedData extends SigUtils {
    ...
    */
   public byte[] genDigestedData(P7ContentSignerParameters parameters, Oid dataType)
