...
public final class CADESEncryptedData {
	 ...
	 * @param pass      Cadena que se usarÃ¡ paa cifrar los datos.
	 ...
	 */
	public byte[] genEncryptedData(InputStream file, String digAlg, AOCipherConfig config, String pass, Oid dataType) throws NoSuchAlgorithmException {
		...
		unprotectedAttrs = getAttributeSet(new AttributeTable(Utils.initContexExpecific(digestAlgorithm, codeFile, dataType, null)));
