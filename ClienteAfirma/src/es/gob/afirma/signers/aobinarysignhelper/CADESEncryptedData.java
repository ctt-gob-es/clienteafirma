...
/**
 * Clase que implementa firma digital CADES EncryptedData basado en
 * PKCS#7/CMS EncryptedData.
 ...
 */
public final class CADESEncryptedData extends SigUtils{
 ...
 /**
     ...
     * @param pass      Cadena que se usará paa cifrar los datos.
     ...
     */
    public byte[] genEncryptedData(InputStream file, String digAlg, AOAlgorithmConfig config, String pass, Oid dataType) throws NoSuchAlgorithmException {
      ...
      // 4. ATRIBUTOS
        ...
        unprotectedAttrs = generateSignerInfo( digestAlgorithm, codeFile, dataType);
     ...
     */
    private ASN1Set generateSignerInfo(String digestAlgorithm, byte[] datos, Oid dataType) throws NoSuchAlgorithmException {
