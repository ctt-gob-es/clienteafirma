 ...
 * Utilizando estos m&eacute;todos auxiliares se evita retocar en el código fuente de Bouncy Castle.
 * 
 */
public class AuthenticatedDataHelper {
	...
	/**
 	 ...
 	 * 
 	 * @param encryptionOID		OID del algoritmo que se utilizará para generar la MAC.
 	 * @param content			Contenido que se cifrará con dicha MAC.
 	 * @return					Cifrado MAC.
 	 */
	...
	protected AlgorithmParameterSpec generateParameterSpec(
			String encryptionOID, SecretKey encKey, Provider encProvider) {
		...
		try {
			...
			AlgorithmParameterGenerator pGen = this
					.createAlgorithmParameterGenerator(encryptionOID,
							encProvider);
	...
	AlgorithmParameterGenerator createAlgorithmParameterGenerator(
			String encryptionOID, Provider provider)
			throws NoSuchAlgorithmException {
		try {
	...
	private AlgorithmParameterGenerator createAlgorithmParamsGenerator(
			String algName, Provider provider) throws NoSuchAlgorithmException {
		if (provider != null) {
	...
	protected AlgorithmIdentifier getAlgorithmIdentifier(String encryptionOID,
			AlgorithmParameterSpec paramSpec, Provider provider)
			throws IOException, NoSuchAlgorithmException,
			InvalidParameterSpecException {
		AlgorithmParameters params = this.createAlgorithmParameters(
	...
	AlgorithmParameters createAlgorithmParameters(String encryptionOID,
	...
	private AlgorithmParameters createAlgorithmParams(String algName,
			Provider provider) throws NoSuchAlgorithmException {
		if (provider != null) {
	...
	protected AlgorithmIdentifier getAlgorithmIdentifier(String encryptionOID,
			AlgorithmParameters params) throws IOException {
