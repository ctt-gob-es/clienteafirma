...
public final class CMSDecipherAuthenticatedData {
	 ...
	 */
	public byte[] decipherAuthenticatedData(byte[] cmsData, PrivateKeyEntry keyEntry) throws IOException, CertificateEncodingException, AOException, AOInvalidRecipientException, InvalidKeyException {
	...
	private void assignKey(byte[] passCiphered, PrivateKeyEntry keyEntry, AlgorithmIdentifier algClave) throws AOException {
		...
		if (algorithm == null) throw new AOException(
