...
public final class CMSDigestedData  {
    ...
    * @param digestAlgorithm Algoritmo de huella digital (<i>digest</i>) a usar
    ...
    */
   public byte[] genDigestedData(final byte[] content, final String digestAlgorithm, final Oid dataType)
        ...
        // digest
        DEROctetString digest = new DEROctetString(
