...
/**
 * Clase que implementa la cofirma digital PKCS#7/CMS SignedAndEnvelopedData
...
public final class CoSignerEnveloped  {
	...
	public byte[] coSigner(final P7ContentSignerParameters parameters, 
        ...
        ASN1Sequence contentSignedData = (ASN1Sequence) doj.getObject();// contenido del signedAndEnvelopedData
