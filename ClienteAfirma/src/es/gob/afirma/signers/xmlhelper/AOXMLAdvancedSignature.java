...
public final class AOXMLAdvancedSignature extends XMLAdvancedSignature {
	...
	/**
	 * A&ntilde;ade una hoja de estilo en modo <i>enveloping</i> dentro de la firma. La referencia para firmarla debe
	 * construirse de forma externa, esta clase no la construye ni a&ntilde;ade
	 * @param s XML de la hoja de estilo (si se proporciona un nulo no se a&ntilde;ade la hoja de estilo)
