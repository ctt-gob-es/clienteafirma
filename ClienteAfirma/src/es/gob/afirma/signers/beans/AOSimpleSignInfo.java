...
/**
 * Clase dise&ntilde;ada para almacenar la informaci&oacute;n m&iacute;nima extraida de
 * un objeto simple de firma.
 */
public final class AOSimpleSignInfo {
     ...
     * <ul><li>La cadena de certificaci&oacute;n (obligatoria).</li>
     * <li>La fecha de firma (opcional).</li></ul>
