...
public final class OOXMLUtil {
	...
	/**
	 * Cuenta el n&uacute;mero de firmas del documento OOXML. Si se produce alg&uacute;n error durante
	 * el an&aacute;lisis del fichero, se devolver&aacute; 0.
	 ...
	 * @return N&uacute;mero de firma del documento OOXML.
	 */
	public static RelationShip[] getOOXMLSignaturesRelationships(byte[] ooxmlFile) {
