...
public final class SingleCertKeyStore extends KeyStoreSpi {
	...
	@Override
	public Enumeration<String> engineAliases() { return certificates.keys(); }

	@Override
	public boolean engineContainsAlias(String alias) {
		if (alias == null) return false;
		for (Enumeration<String> e = engineAliases(); e.hasMoreElements();) if (e.nextElement().equals(alias)) return true;
		return false;
	}
	...
	@Override
	public Date engineGetCreationDate(String arg0) { return new Date(); }
	...
	@Override
	public boolean engineIsCertificateEntry(String arg0) { return false; }

	@Override
	public boolean engineIsKeyEntry(String arg0) { return false; }
	...
	public void engineLoad(InputStream is, char[] pwd) throws IOException, NoSuchAlgorithmException, CertificateException {
		...
		try {
			...
			Logger.getLogger("es.gob.afirma").warning(
				"La factoria no ha podido generar los certificados directamente, se probara con un pretratamiento: " + e
			);
		...
		// Si la coleccion es nula queda la opcion de que haya que pretratar, aun cuando no salto la
		// excepcion...
...
//	}
	...
	private void addCertificate(String base64Cert, String alias) {
		...
		try {
			...
			Logger.getLogger("es.gob.afirma").warning("Error generando el certificado, no se anadira al almacen: " + e);
			return;
		}
		if (tmpCert == null) {
