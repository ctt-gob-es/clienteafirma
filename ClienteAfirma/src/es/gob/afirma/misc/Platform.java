...
public final class Platform {
	...
	public static void init() {
		try {
			...
			if (jreVersion.startsWith("1.0") ||
				jreVersion.startsWith("1.1") ||
	 ...
	 * @return <code>true</code> si si la instancia est&aacute;tica est&aacute; inicializada, 
	 ...
	 * @return Navegador web desde el que se realiza la ejecuci&oacute;n o {@code null} si
	 * no se realiza desde un navegador. 
	 */
	 ...
	 * @param userAgent UserAgent del aplicativo de acceso. 
	 */
	public static void setUserAgent(String userAgent) {
		...
		if (userAgent == null) {
			...
			// CUIDADO: Chrome incluye la cadena "safari" como parte de su UserAgent
