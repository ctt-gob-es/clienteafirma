...
public final class AOConstants {
    ...
    /** Identificador del modo de firma Explicita (Los datos NO se incluyen en la firma). */
    public static final String SIGN_MODE_EXPLICIT = "explicit";
    
    /** Identificador del modo de firma Implicita (Los datos SI se incluyen en la firma). */
    ...
    /** Identificador de la operaci&oacute;n de contrafirma masiva de todo el &aacute;rbol de firma. */
    public static final String MASSIVE_OPERATION_COUNTERSIGN_TREE = "CONTRAFIRMAR_ARBOL";
    
    /** Identificador de la operaci&oacute;n de contrafirma masiva de nodos hoja de firma. */
	...
	public static final String DEFAULT_OID_TO_SIGN = "1.3.6.1.4.1.1466.115.121.1.40"; //Octect String
    ...
    public enum AOCipherAlgorithm {
    	 ...
    	 * @return <code>true</code> si el algoritmo soporta contrase&ntilde;as (en vez de claves),
    	 ...
    	 * @return <code>true</code> si el algoritmo soporta claves (en vez de contrase&ntilde;as),
    	 *         <code>false</code> en caso contrario
    	 */
    	 ...
    	 * indicado es nulo o no esta soportado, se devolver&aacute; <code>null</code>.
    ...
    public enum AOCipherPadding {
    	...
    	/**
    	 * Recupera el relleno soportado cuyo nombre se indique. Si el relleno indicado
    	 * es nulo o no est&aacute; soportado, se devolver&aacute; <code>null</code>.
    	...
    	public static AOCipherPadding getValueOf(String paddingName) {
    		for(AOCipherPadding padding : AOCipherPadding.values()) if(padding.getName().equals(paddingName)) return padding;
    		return null;
		}
    }
    ...
    public enum AOCipherBlockMode {
    	...
    	/**
    	 * Recupera el modo de bloque soportado cuyo nombre se indique. Si el modo de bloque
    ...
    /** Modo de generaci&oacute;n autom&aacute;tica de clave sim&eacute;trica aleatoria. */
    ...
    public enum AOKeyStore {
    	...
    	/** Mozilla / Firefox (NSS / PKCS#11, con m&oacute;dulos de seguridad internos y externos unificados). */
    	MOZ_UNI ("Mozilla / Firefox (unificado)", 7, "PKCS11"),
    	/** Java Cryptography Extension KeyStore (JCEKS). */
    	JCEKS   ("Java Cryptography Extension KeyStore (JCEKS)", 8, "JCEKS"),
    	/** Java KeyStore (JKS, distinguiendo entre may&uacute;sculas y min&uacute;sculas). */
...
//    	WINDEPLOY("Windows / Internet Explorer (despliegue)", 13, "WIExplorerMy")
    ...
    /** <i>KeyUsage</i> t&iacute;pico de un certificado v&aacute;lido para firmas digitales. */
