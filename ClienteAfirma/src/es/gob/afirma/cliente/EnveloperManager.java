...
/**
 * Manejador para el ensobrado de datos por parte del Applet Cliente @firma. Esta clase almacena toda la
 * informaci&oacute;n relevante para las operaciones de ensobrado y desensobrado y proporciona las
 * funcionalidades b&aacute;sicas para realizar estas operaciones. 
 */
public final class EnveloperManager {
	...
	/** Manejador de almacenes del que extraer las claves para el ensobrado y desensobrado
	 * de datos cuando no se indique la clave del remitente. */
	...
	/**
	 * Construye el objeto y establece un componente padre sobre el que mostrar los di&aacute;logos
	 * modales.
	 * @param parent Componente sobre el que mostrar los di&aacute;logos.
	 */
	...
	/**
	 * Inicializa la configuraci&oacute;n del manejador a la configuraci&oacute;n por defecto.
	 */
	...
	/**
	 * Recupera la URI del fichero configurado. Si no hay ninguno, se devuelve
	 * {@code null}.
	 ...
	 * @param manager Manejador de cifrado.
	 */
	...
	/**
	 * Establece el tipo de envoltorio que se debe generar. Los tipos
	 * soportados est&aacute;n declarados en {@link AOConstants}.
	 * @param cmsContentType Tipo de envoltorio.
	 */
	...
	/**
	 * Recupera los certificados de los destinatarios de un sobre electr&oacute;nico.
	...
	/**
	 * Establece el algoritmo para las firmas de los sobres. Si no se establece uno, se utilizar&aacute;
	 * el por defecto. 
	 ...
	 * @param manager Manejador de almacenes.
	 */
	 ...
	 * @param cert Certificado del nuevo destinatario.
	 */
	...
	/**
	 * Agrega un nuevo destinatario al sobre electr&oacute;nico.
	 * @param certEncoded Certificado codificado del nuevo destinatario.
	...
	/**
	 * Elimina todos los destinatarios configurados para el sobre electr&oacute;nico.
	 */
	 ...
	 * @throws AOCertificateException Cuando ocurre un error en la decodificaci&oacute;n del certificado.
	 */
	 ...
	 * @throws NoSuchAlgorithmException  Cuando el algoritmo de firma no est&aacuta; soportado.
	 * @throws CertificateEncodingException  Cuando el certificado del remitente no es v&aacute;lido.
	 * @throws AOException  Cuando ocurre algun error al envolver los datos.
	 * @throws IllegalArgumentException Cuando no se ha indicado un par&aacute;metro o se configur&oacute; uno err&oacute;neo.
	...
	/**
	 * Genera un sobre electr&oacute;nico. No guarda en el manager los datos que se le pasan
	 ...
	 * @throws CertificateEncodingException  Cuando el certificado del remitente no es v&aacute;lido.
	 * @throws AOException  Cuando ocurre algun error al envolver los datos.
	 * @throws NullPointerException Cuando se ha indicado el tipo de contenido o los destinatarios del mismo.
	 * @throws IllegalArgumentException Cuando se configur&oacute; un par&aacute;metro err&oacute;neo.
	 * @throws AOCancelledOperationException Cuando el usuario cancela la operaci&oacute;n. 
	 */
	 ...
	 * @throws NoSuchAlgorithmException Cuando el algoritmo de cifrado no est&aacute; soportado.	 * @throws IOException
	 */
	 ...
	 * @param content           Datos a encriptar
	 * @throws AOException Cuando ocurre cualquier problema durante el proceso
	 ...
	 * @throws AOInvalidRecipientException Cuando el usuario no es uno de los destinatarios del sobre.
	 * @throws CertificateEncodingException Cuando el certificado del destinatario no es v&aacute;lido.
	 * @throws IOException Cuando el envoltorio est&aacute; corrupto o no puede leerse.
	 * @throws AOInvalidFormatException Cuando no se ha indicado un envoltorio soportado.
	 ...
	 * @param envelop Sobre electr&oacute;nico a desenvolver
	 * @throws AOInvalidRecipientException Cuando el usuario no es uno de los destinatarios del sobre.
	 * @throws CertificateEncodingException Cuando el certificado del destinatario no es v&aacute;lido.
	 * @throws IOException Cuando el envoltorio est&aacute; corrupto o no puede leerse.
	 * @throws AOInvalidFormatException Cuando no se ha indicado un envoltorio soportado.
	...
	public void unwrap(final byte[] envelop) throws CertificateEncodingException, 
		...
		// Comprobamos si requiere un certificado para la extraccion de los datos
		if (enveloper.isCMSValid(envelop, AOConstants.CMS_CONTENTTYPE_ENVELOPEDDATA) ||
			enveloper.isCMSValid(envelop, AOConstants.CMS_CONTENTTYPE_SIGNEDANDENVELOPEDDATA) ||
	...
	/**
	 * Recupera los datos configurados como entrada para la operacion de ensobrado. Si no hay datos
	 * configurados muestra un di&aacute;logo para la selecci&oacute;n de un fichero. 
	 * @return Contenido configurados.
	 * @throws IOException Cuando ocurre algun problema en la lectura de los datos.
	 */
	...
	/**
	 * Obtiene los datos configurados como entrada para la operacion. Si no hay un envoltorio configurado
	 * muestra un di&aacute;logo para la selecci&oacute;n de un fichero.
	...
	/**
	 * Recupera el contenido del fichero. Si no hay ning&uacute;n fichero configurado, muestra un
	 * di&aacute;logo al usuario para que lo seleccione.
	 * @return Contenido del fichero.
	 * @throws IOException Cuando ocurre un error al determinar o leer el fichero configurado.
	 */
	private byte[] recoverDataFromFile() throws IOException {
		...
		try {
			...
			try { if (is != null) is.close(); } catch (Throwable e) { }
		}
	}
	
	/**
	 * Genera un envoltorio CMS (no sobre electr&oacute;nico) de tipo EncryptedData.
	 ...
	 * @throws NoSuchAlgorithmException Cuando la configuraci&oacute;n de cifrado no sea v&aacute;lida.
	 */
	private byte[] createCMSEncryptedData(final byte[] content) throws AOException, NoSuchAlgorithmException {
		return enveloper.createCMSEncryptedData(
			content, cipherManager.getCipherConfig(), cipherManager.getConfiguredKey()
		);
	}
	 ...
	 * @param content Datos que queremos ensobrar.
	 * @param originatorKe Clave del remitente del sobre.
	 * @return Sobre electr&oacute;nico.
	 * @throws IOException Cuando ocurre un error de lectura de datos.
	 * @throws CertificateEncodingException El certificado de firma no es v&aacute;lido.
	 * @throws NoSuchAlgorithmException Algoritmo no soportado.
	 */
	private byte[] createCMSEnvelopData(final byte[] content) throws IOException, CertificateEncodingException, NoSuchAlgorithmException {
		return enveloper.createCMSEnvelopedData(
			content,
			ksConfigManager.getCertificateKeyEntry(),	// Si hay uno seleccionado, se utiliza
	 ...
	 * @throws IllegalArgumentException Cuando no se ha introducido alg&uacute;n par&aacute;metro requerido por el tipo de sobre
	 */
	private byte[] createCMSSignedEnvelopData(final byte[] content) throws AOException, 
		...
		return enveloper.createCMSSignedAndEnvelopedData(
				content,
	...
	private byte[] createCMSAuthenticatedEnvelopData(final byte[] content) throws AOException, 
		...
		return enveloper.createCMSAuthenticatedEnvelopedData(
				content,
				ksConfigManager.getCertificateKeyEntry(),
				cipherManager.getCipherConfig(),
				this.getRecipients());
	...
	/**
	 * Agrega un nuevo remitente a un sobre electr&oacute;nico. Los tipos de contenido CMS
	 * que soportan m&uacute;ltiples remitentes son EnvelopedData, SignedAndEnvelopedData
	 * y AuthenticatedAndEnvelopedData.
	 * @param envelop Envoltorio al que se desea agrehar el nuevo remitente.
	 * @return Sobre electr&oacute;nico con el remitente agregado. 
	 * @throws AOException Cuando se produce un error durante el proceso de ensobrado.
	 * @throws AOCancelledOperationException Cuando el usuario cancela la operaci&oacute;n.
	...
	/**
	 * Recupera los datos extra&iacute;dos de un envoltorio o preparados para insertarse en el mismo. 
	 ...
	 * @param oid Identificador del objeto a introducir.
	 ...
	 * @param oid Identificador del atributo a introducir.
	 * @param value Valor asignado
	 */
