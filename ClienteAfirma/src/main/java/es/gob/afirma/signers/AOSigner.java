...
public interface AOSigner {
	 ...
	 * Los nodos que se deben firmar se indican en <code>targetType</code> y pueden ser:
	 * <ul>
	 ...
	 * <li>Los nodos de firma realizados por los firmantes cuyo <i>Common Name</i> se indica en
	 * <code>target</code></li>
	 * </ul>
	 ...
	 * en la firma electr&oacute;nica.<br/>
	 * El fichero se considera el nodo ra&iacute;z, la firma y cofirmas pender&aacute;n
	 * directamentede de &eacute;ste. 
	 ...
	 * de firma.<br/>
	 * Por ejemplo, un signer CMS siempre devolver&iacute;a <code>true</code> , ya que puede
	 * firmar cualquier fichero binario, en cambio, un signer de PDF s&oacute;lo podr&iacute;a
	 * firmar PDF. Si un signer puede firmar unos datos segun la configuraci&oacute;n establecida
	 * para la firma, se aceptar&aacute;n todos los formatos permitidos para alguna de las
	 * configuraciones. Por ejemplo, un signer XAdES aceptar datos XML o binarios para la firma
	 * Detached pero s&oacute;lo XML para la Enveloped. Si este signer recibe unos datos binarios,
	 * devolver&aacute; <code>true</code>.
	 * @param is Dato que deseamos comprobar.
	 ...
	 * un fichero con el nombre asignado. Si se indica una part&iacute;cula intermedia, se devolver&aacute;
	 * el nombre con esta particula asignada siempre y cuando esto tenga sentido. 
	 * @param originalName Nombre del fichero original que se firma
	 * @param inText Particula intermedia que agregar al nombre del fichero de firma.
	 ...
	 * @param description Descripci&oacute;n opcional del elemento DataObjectFormat
	 * @param objectIdentifier Instancia de <code>ObjectIdentifier</code>
	 * @param mimeType MimeType de los datos. Por defecto <code>application/octet-stream</code>
	 * @param encoding Codificaci&oacute;n de los datos. Por defecto <code>base64</code>
	 */
	...
	/**
	 * Recupera los datos originalmente firmados de la firma pasada por par&aacute;metro.
	 * En caso de no contener la firma los datos firmados, se devuelve <code>null</code>.
	 * @param signData Datos de firma.
	 * @return Datos originalmente firmados. 
	 * @throws AOInvalidFormatException No se ha introducido un fichero de firma v&aacute;lido
	 * o no ha podido leerse la firma.
	 ...
	 * @throws AOInvalidFormatException  Cuando la firma introducida no es un objeto de firma
	 ...
	 * puede haber un tipo de datos por defecto: application/octect-stream, data...
