...
public final class ReadNodesTree {
    ...
    /**
     * M&eacute;todo que, apartir de un numero de serie de un certificado, devuelve su
     * nombre com&uacute;n (CN). De no existir el CN, devolver&aacute; el nombre de la unidad
     * organizativa.
     *
    ...
    /**
     * A partir de un numero de serie de un certificado, devuelve un
     * array con el certificado y su cadena de confianza.
     *
     * @param certificates      Certificados de los firmantes.
     * @param serialNumber      N&uacute;mero de serie del certificado a firmar.
	...
	private X509Certificate[] searchCert(ASN1Set certificates, DERInteger serialNumber) {
        ...
        while (certSet.hasMoreElements()) {
            ...
            TBSCertificateStructure atrib = TBSCertificateStructure.getInstance(atrib2.getObjectAt(0));
            if (serialNumber.toString().equals(atrib.getSerialNumber().toString())) {
            	// Es el certificado bueno, creamos el array con un único elemento y lo devolvemos
            	...
            	try {
            		...
            		Logger.getLogger("es.gob.afirma").severe(
        				"No se pudieron recuperar los certificados de la lista, se devolvera un array vacio: " + e
        			);
		...
		Logger.getLogger("es.gob.afirma").severe(
			"El certificados pedido no estaba en la lista, se devolvera un array vacio"
		);	
    	return new X509Certificate[0];
    }
