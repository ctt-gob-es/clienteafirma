...
public final class AOCAdESSigner implements AOSigner {
    	...
    	if (signedData){
	        try {
	            return new CadesCoSigner().coSigner(
	        		...
	        		dataType,
	        		keyEntry,
	        		null // null porque no nos pueden dar un hash en este metodo, tendr�a que ser en el que incluye datos
	    		);
	        }
	        catch (Throwable e) {
	            throw new AOException("Error generando la Cofirma CADES", e);
     ...
     * Se realiza la verificaciÃƒÂ³n sobre los los siguientes tipos de CMS reconocidos:
     * <ul>
     *  <li>Data</li>
     *  <li>Signed Data</li>
     *  <li>Digested Data</li>
