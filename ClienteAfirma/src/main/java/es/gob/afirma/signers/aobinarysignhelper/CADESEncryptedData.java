...
public final class CADESEncryptedData {
     ...
     *         digital */
    public byte[] genEncryptedData(final InputStream file, final String digAlg, final AOCipherConfig config, final String pass, final Oid dataType) throws NoSuchAlgorithmException {
