...
public final class CADESDigestedData {
	 ...
	 *             datos
	 */
	public byte[] genDigestedData(P7ContentSignerParameters parameters,
			Oid dataType) throws NoSuchAlgorithmException, IOException {
		if (parameters == null) {
		...
		try {
			...
			throw new IOException((new StringBuilder())
					.append("Error de codificacion: ").append(e).toString());
		}
		...
		DEROctetString digest = new DEROctetString(MessageDigest.getInstance(
				digestAlgorithm.toString()).digest(data));
