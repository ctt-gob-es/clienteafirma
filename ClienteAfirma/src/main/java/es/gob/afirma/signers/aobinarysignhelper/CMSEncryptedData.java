...
public final class CMSEncryptedData {
	 ...
	 *             digital
	 */
	public byte[] genEncryptedData(byte[] data, String digAlg,
			AOCipherConfig config, Key cipherKey, Oid dataType,
			Map<Oid, byte[]> uatrib) throws NoSuchAlgorithmException {
