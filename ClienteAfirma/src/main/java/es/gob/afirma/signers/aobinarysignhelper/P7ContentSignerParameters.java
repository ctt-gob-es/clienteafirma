...
public final class P7ContentSignerParameters {
	 ...
	 */
	public P7ContentSignerParameters(final byte[] data2,
			String signatureAlgorithm, X509Certificate[] cChain) {

		data = data2;

		if (signatureAlgorithm == null || signatureAlgorithm.length() < 1) {
			Logger.getLogger("es.gob.afirma").warning(
					"No se especifico algoritmo para la firma CADES, se utilizara "
	...
	public URI getTimestampingAuthority() {
		Logger.getLogger("es.gob.afirma")
				.info("Se ha solicitado la URI de la autoridad de sellado de tiempo, pero como es una caracteristica "
	...
	public X509Certificate getTimestampingAuthorityCertificate() {
		Logger.getLogger("es.gob.afirma")
				.info("Se ha solicitado el certificado de la autoridad de sellado de tiempo, pero como es una caracteristica "
						+ "aun no soportada se devolvio null");
		return null;
	}
}