...
final class Utils {
	...
	public static SecretKey assignKey(final AOCipherConfig config, final String key) {
		...
		if ((config.getAlgorithm().equals(AOCipherAlgorithm.PBEWITHMD5ANDDES)) ||
			...
			try {
				return SecretKeyFactory.getInstance(config.getAlgorithm().getName())
	 ...
	 * @param signerCertificateChain	Cadena de certificados firmantes
	 * @return ASN1Set
	 * @throws IOException
	 * @throws CertificateEncodingException
	 */
	public static ASN1Set fetchCertificatesList(final X509Certificate[] signerCertificateChain) 
	...
	public static Info initVariables(byte[] data, AOCipherConfig config, 
			X509Certificate[] certDest, SecretKey cipherKey) throws IOException, CertificateEncodingException {
	 ...
	 */
	public static ASN1EncodableVector initContexExpecific(String digestAlgorithm,
			byte[] datos, Oid dataType, byte[] messageDigest) throws NoSuchAlgorithmException {
	...
	public static OriginatorInfo checkCertificates(X509Certificate[] signerCertificateChain, OriginatorInfo origInfo,
	 ...
	 * @throws CertificateEncodingException
	 */
	public static EncryptedKeyDatas fetchEncryptedKeyDatas(X509Certificate userCert, Enumeration<?> elementRecipient) 
	 ...
	 * @param cmsData	Bytes con los datos
	 * @return			ASN1Sequence
	 * @throws IOException
	 */
	...
	public static SecretKey loadCipherKey(AOCipherConfig config, String key) throws InvalidKeySpecException, NoSuchAlgorithmException {
		SecretKey cipherKey = SecretKeyFactory.getInstance(config.getAlgorithm().getName())
		.generateSecret(new PBEKeySpec(key.toCharArray(), SALT, ITERATION_COUNT));
	...
	public static KeyAsigned assignKey(final byte[] passCiphered, 
			                           ...
			                           final AlgorithmIdentifier algClave) throws AOException {
	 ...
	 * @throws java.io.IOException
	 */
	public static ASN1Set generateSignerInfo(String digestAlgorithm, byte[] datos,
			Oid dataType, Map<Oid, byte[]> uatrib) throws NoSuchAlgorithmException {

		//// ATRIBUTOS

		//authenticatedAttributes
		ASN1EncodableVector ContexExpecific = Utils.initContexExpecific(digestAlgorithm,
				datos, dataType, null);
	 ...
	 * @throws CertificateEncodingException
	 */
	public static ASN1EncodableVector loadCertificatesList(SignedAndEnvelopedData signEnv,
	...
	public static SignerInfo signAndEnvelope(PrivateKeyEntry keyEntry,
			...
			ASN1Set unSignedAttr, AlgorithmId digestAlgorithmIdEnc, ASN1Set signedAttr2)
	throws IOException {
	 ...
	 * @throws CertificateEncodingException 
	 */
	public static ASN1EncodableVector generateSignerInfo(X509Certificate cert, AlgorithmId digestAlgorithmId, String digestAlgorithm,
			AlgorithmIdentifier digAlgId, byte[] datos, String politica, Oid qualifier, boolean signingCertificateV2,
			Oid dataType, byte[] messageDigest) throws NoSuchAlgorithmException, IOException, CertificateEncodingException{
		//// ATRIBUTOS
