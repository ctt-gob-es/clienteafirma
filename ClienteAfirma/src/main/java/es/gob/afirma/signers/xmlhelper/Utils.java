...
public final class Utils {
    ...
    public static void checkIllegalParams(final String format,
        ...
        if (xades) { // XAdES
            ...
            if (!format.equals(SIGN_FORMAT_XADES_DETACHED) && !format.equals(SIGN_FORMAT_XADES_ENVELOPED)
            ...
            if (!format.equals(AOConstants.SIGN_FORMAT_XMLDSIG_DETACHED) && !format.equals(AOConstants.SIGN_FORMAT_XMLDSIG_ENVELOPED)
