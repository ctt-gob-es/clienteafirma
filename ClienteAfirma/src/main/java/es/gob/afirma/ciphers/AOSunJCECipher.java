...
public final class AOSunJCECipher implements AOCipher {
    ...
    public byte[] cipher(final byte[] data, final AOCipherConfig algorithmConfig, final Key cipherKey) throws AOException, AOInvalidKeyException {
        ...
        try {
            ...
            throw new AOInvalidKeyException("La clave de cifrado introducida no es valida para el algoritmo '" + algorithmConfig.getAlgorithm()
                                                                                                                                .getName() + "'", e);
        }
        catch (final Exception e) {
    ...
    public byte[] decipher(final byte[] data, final AOCipherConfig algorithmConfig, final Key decipherKey) throws AOException, AOInvalidKeyException {
        ...
        try {
            ...
            throw new AOInvalidKeyException("La clave de descifrado introducida no es valida para el algoritmo '" + algorithmConfig.getAlgorithm()
                                                                                                                                   .getName() + "'",
                                            e);
        }
        catch (final Exception e) {
