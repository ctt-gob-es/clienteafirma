...
public final class AOCipherConfig {
	 ...
	 */
	public AOCipherConfig(AOCipherAlgorithm ciphAlgo,
			AOCipherBlockMode ciphMode, AOCipherPadding ciphPadding) {
	 ...
	 */
	public static AOCipherConfig parse(String cipherConfig)
			throws NoSuchAlgorithmException {
	...
	public String toString() {
		...
		if (mode != null && padding != null) {
			config.append("/").append(mode.getName()).append("/")
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof AOCipherConfig))
			return false;
		return ((AOCipherConfig) obj).algo.equals(algo)
				&& ((AOCipherConfig) obj).mode.equals(mode)
				&& ((AOCipherConfig) obj).padding.equals(padding);
	}

	@Override
	public int hashCode() {
		return this.algo.hashCode() + this.mode.hashCode()
				+ this.padding.hashCode();
	}
