...
public interface EntryPointsCrypto {
	 ...
	 * <dl>
	 * <dt>
	 * Para la selecci&oacute;n de certificado (opcional, excluyentes), si no se
	 * especifica ninguno, se muestra una ventana al usuario para que
	 ...
	 * </dd>
	 * <dt>
	 * Para la selecci&oacute;n de datos de entrada(opcional, excluyentes): Si
	 * no se especifica ninguno, se muestra una ventana al usuario para que
	 * escoja un fichero a firmar</dt>
	 * <dd>
	 * <ul>
	 * <li>data</li>
	 * <li>hash</li>
	 ...
	 * </dd>
	 * <dt>
	 * Par&aacute;metros de salida:</dt>
	 * <dd>
	 * <dl>
	 ...
	 * <li>fileUsedPath (si se han le&iacute;do los datos a firmar de un
	 * fichero)</li>
	 ...
	 * <dl>
	 * <dt>
	 * For the selection of certificates (optional, exclusive), if none is
	 * specified, a window is displayed prompting the user to choose among
	 ...
	 * </dd>
	 * <dt>
	 * For the selection of input data (optional, exclusive): if none is
	 * specified, a window is displayed, prompting the user to select the file
	 * to be signed.</dt>
	 * <dd>
	 * <ul>
	 * <li>data</li>
	 ...
	 * </dd>
	 * <dt>
	 * For electronic signature (optional): If none are specified, default
	 * values are used.</dt>
	 * <dd>
	 * <ul>
	 * <li>signatureAlgorithm</li>
	 ...
	 * @return <code>true</code> si se ha ejecutado correctamente,
	 *         <code>false</code> en caso contrario <br>
	 *         <code>true</code> if execution is correct, else
	 *         <code>false</code>.
	 */
	public boolean sign();
	 ...
	 * formato debe reconocer el OID especificado, siendo el atributo
	 * {@code value} su valor como cadena de texto. <br>
	 * <br>
	 ...
	 * <ul>
	 * <li><b>http://www.w3.org/TR/1999/REC-xpath-19991116</b>:
	 * Transformaci&oacute;n de tipo XPATH.</li>
	 * <li><b>http://www.w3.org/2002/06/xmldsig-filter2</b>:
	 * Transformaci&oacute;n de tipo XPATH2.<br/>
	 * Subtipos:
	 * <ul>
	 * <li>subtract</li>
	 * <li>intersect</li>
	 ...
	 * </ul>
	 * </li>
	 * <li><b>http://www.w3.org/TR/1999/REC-xslt-19991116</b>:
	 * Transformaci&oacute;n de tipo XSLT.</li>
	 * <li><b>http://www.w3.org/2000/09/xmldsig#base64</b>:
	 * Transformaci&oacute;n de tipo BASE64.</li>
	 * <li><b>http://www.w3.org/2000/09/xmldsig#enveloped-signature</b>:
	 * Transformaci&oacute;n de tipo ENVELOPED.</li>
	 * </ul>
	 ...
	 * <ul>
	 * <li><b>http://www.w3.org/TR/1999/REC-xpath-19991116</b>: Type XPATH
	 * transformation.</li>
	 * <li><b>http://www.w3.org/2002/06/xmldsig-filter2</b>: Type XPATH2
	 * transformation.<br/>
	 * Subtypes:
	 * <ul>
	 * <li>subtract</li>
	 ...
	 * </ul>
	 * </li>
	 * <li><b>http://www.w3.org/TR/1999/REC-xslt-19991116</b>: Type XSLT
	 * transformation.</li>
	 * <li><b>http://www.w3.org/2000/09/xmldsig#base64</b>: Type BASE64
	 * transformation.</li>
	 * <li><b>http://www.w3.org/2000/09/xmldsig#enveloped-signature</b>: Type
	 * ENVELOPED transformation.</li>
	 * </ul>
	 * Should a transformation have no subtype,{@code null} will be indicated.
	 * Transformations of type BASE64 and ENVELOPED do not need a body (
	 * {@code null} shall be used)
	 * 
	 * 
	 * @param type
	 ...
	 * <li>Ruta al fichero firmado si no se introdujeron los datos directamente
	 * ({@link #getFileUsedPath()})</li>
	 * <li>Certificado de firma en base 64 (
	 * {@link #getSignCertificateBase64Encoded()})</li>
	 * </ul>
	 ...
	 * <li>Route to the signed file, if data has not been entered directly (
	 * {@link #getFileUsedPath()})</li>
	 * <li>Signature certificate in base 64 (
	 * {@link #getSignCertificateBase64Encoded()})</li>
	 * </ul>
	 ...
	 *         <code>true</code> if the operation ended successfully. Else,
	 *         <code>false</code>.
	 */
	 ...
	 * "firmante1\n\tfirmante2\n\tfirmante3\n\t\tfirmante4\nfirmante5"</li>
	 * </ul>
	 * La firma puede ser establecida mediante
	 * {@link #setElectronicSignature(String)} o
	 * {@link #setElectronicSignatureFile(String)}. El an&aacute;lisis de la
	 ...
	 * <li>'Complex' Signature:
	 * "signer1\n\tsigner2\n\tsigner3\n\t\tsigner4\nsigner5"</li>
	 * </ul>
	 * Signature may be set with {@link #setElectronicSignature(String)} or
	 * {@link #setElectronicSignatureFile(String)}. Signature analysis is
	 ...
	 * seleccionado se devolver&aacute; cadena vac&iacute;a.
	 * 
	 * 
	 * 
	 * <br>
	 ...
	 * ning&uacute;n certificado seleccionado se devolver&aacute;
	 * <code>null</code>.
	 * 
	 * <br>
	 * <br>
	...
	/**
	 * Establece un filtro para los certificados que se mostrar&aacute;n al
	 * usuario.<br>
	 ...
	 * <b>operador</b>: = (igual o equivalente), #MATCHES# (cumple un
	 * expresi&oacute;n regular)<br>
	 ...
	 * <b>Certificatefield</b>: ISSUER.DN (Issuer Domain Name), SUBJECT.DN
	 * (Certificate's Domain Name), SUBJECT.FP(MD5) (Certificate's Digital
	 * fingerprint in MD5, in hexadecimal, separated by ':', (D0:BA:34:4D...)),
	 * SUBJECT.FP(SHA1) (Certificate's digital fingerprint in SHA1, in
	 * hexadecimal, separated by ':', (D0:BA:34:4D...)), SUBJECT.SN
	 * (certificate's serial no.)<br>
	 * <b>operador</b>: = (equals or equivalent), #MATCHES# (matches a regular
	 * expression)<br>
	 ...
	 * 
	 * @param certFilter
	 *            Filtro para los certificados a mostrar al usuario <br>
	 *            Certificate filter to be shown to the user.
	 * @deprecated Sustituido por
	 *             {@link #setCertFilterRFC2254(String, String, boolean)} <br>
	 *             Replaced by
	 *             {@link #setCertFilterRFC2254(String, String, boolean)}
	 * @see #setCertFilterRFC2254(String, String, boolean)
	 */
	@Deprecated
	 ...
	 * entiende que se le "obliga" a firmar con uno concreto. Si ning&uacute;n
	 * certificado instalado en el navegador cumple la condici&oacute;n, se
	 * mostrar&aacute; un error. Si m&aacute;s de uno la cumple, tambi&eacute;n
	 * (la condici&oacute;n no selecciona un certificado &uacute;nico).<br>
	 * <br>
	 * Las condiciones simples siguen el siguiente patr&oacute;n:<br>
	 * {campoDelCertificado operador {"valor"}}<br>
	 * <b>campoDelCertificado</b>: ISSUER.DN (Domain Name del emisor),
	 ...
	 * <br>
	 * 
	 * Sets a condition to select the certificate for signature. User may not
	 * choose a certificate, as they are deemed "forced" to sign with a specific
	 * one. If no certificate installed in browser meets the condition (or more
	 * than one does), an error will be displayed. Condition does not select a
	 * single certificate.<br>
	 * <br>
	 * Simple conditions follow this pattern:<br>
	 * {certificateField operator {"value"}}<br>
	 * <b>certificateField</b>: ISSUER.DN (Domain Name del emisor), SUBJECT.DN
	 * (Certificate's Domain Name), SUBJECT.FP(MD5) (Certificate's Digital
	 * Fingerprint in MD5, in hexadecimal separated by ':', (D0:BA:34:4D...)),
	 * SUBJECT.FP(SHA1) (Certificate's Digital Fingerprint in SHA1, in
	 * hexadecimal separated by ':', (D0:BA:34:4D...)), SUBJECT.SN
	 * (N&uacute;mero de serie del certificado)<br>
	 * <b>operador</b>: = (equals or equivalent), #MATCHES# (matches a regular
	 * expression)<br>
	 ...
	 * 
	 * 
	 * @param mandatoryCertificateCondition
	 *            Condici&oacute;n que selecciona un (y s&oacute;lo un)
	 *            certificado. Condition for the selection of one (and only one)
	 *            certificate.
	 * @see #setCertFilter(String)
	 * @deprecated Usar &uacute;nicamente
	 *             {@link #setMandatoryCertificateConditionRFC2254(String, String, boolean)}
	 * <br>
	 *             Only use
	 *             {@link #setMandatoryCertificateConditionRFC2254(String, String, boolean)}
	...
	public void setMandatoryCertificateCondition(
			String mandatoryCertificateCondition);

	/**
	 * Establece los los datos cifrados en base 64 que se van a descifrar
	 * mediante una pr&oacute;xima llamada a {@link #decipherData()}.
	 * 
	 * <br>
	 * <br>
	 * 
	 * Sets the encrypted data in base 64 to be decrypted by a call to
	 * {@link #decipherData()}.
	 * 
	 * @param data
	 ...
	 * <br>
	 * 
	 * Returns the encrypted data. If no encrypted data have been set,
	 ...
	 * de no haber ocurrido ninguna de estas condiciones, se devolver&aacute;
	 * <code>null</code>.
	 * 
	 * <br>
	 * <br>
	 ...
	 * resultados de la operaci&oacute;n realizada.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * 64. Si no se dispone de una firma, se devuelve cadena vac&iacute;a.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * una firma XML. Para firmas binarias debe utilizarse
	 ...
	 * results of a XML signature. For binary signatures
	 ...
	 * entrada para operar (cifrar, firmar, leer...) Se soporta el protocolo
	 * <code>file://</code> para ficheros en almacenamiento local. <br/>
	 * Los datos introducidos mediante esta funci&oacuten;n
	 * sobreescribir&aacute;n cualquier otro establecido previamente mediante
	 * los m&eacute;todos setData o setHash.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * operate (i.e., encrypt, sign, read, etc.) with. <code>file://</code>
	 * protocol is supported, for locally stored files. <br/>
	 * Data entered with this function will overwrite any other which may have
	 ...
	 * base 64 no realiz&aacute;ndose la comprobaci&oacute;n de los mismos.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * puede hacerse establecido program&aacute;ticamente mediante
	 * {@link #setOutFilePath(String) setOutFilePath} o mediante la interfaz que
	 ...
	 * haberse establecido program&aacute;ticamente mediante
	 * {@link #setFileuri(String) setFileuri} o mediante la interfaz que aparece
	 ...
	 * previamente deberemos obtener una URI.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * does not allow directly acquiring a file by the class
	 * {@link java.io.File}. An URI must be previously acquired.
	 * 
	 ...
	 * cofirma y contrafirma (en cada una de sus variedades).
	 * 
	 * 
	 * <br>
	 * <br>
	 ...
	 * performed, signers names will be indicated in the way returned by
	 * {@link #getSignersStructure()}. In case of nodes' counter-signature,
	 ...
	 * anteriormente en un fichero especificado.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * @return <code>true</code> si los datos se han guardado correctamente,
	 *         <code>false</code> en caso contrario. <br>
	 *         <code>true</code> if data has been stored successfully. Else,
	 *         <code>false</code>.
	 */
	 ...
	 * recuperarse la ruta de fichero mediante getFileUsedPath().
	 * 
	 * <br>
	 * <br>
	 * 
	 * Encrypts the specified file. This operation's result is equivalent to
	 * executing {@link #cipherData()} method, after indicating a file with
	 * {@link #setFileuri(String)}. The file’s path can’t recovered using
	 ...
	 * descifrar pueden establecerse en base 64 mediante el m&eacute;todo
	 * {@link #setCipherData(String)} o, de tratarse de un fichero, a
	 ...
	 * con {@link #savePlainDataToFile(String)}.
	 * 
	 * <br>
	 * <br>
	 * 
	 * Performs a decryption operation. Data to decrypt may be set in base 64
	 * with the {@link #setCipherData(String)} method or, if a file, with
	 * {@link #setFileuri(String)}. Encryption configuration used for the data
	 ...
	 * <li>AES/ECB/PKCS5PADDING</li>
	 * </ul>
	 * According to the encryption algorithm, the {@link #setKeyMode(String)}
	 * must be used, and a mandatory encryption key in base 64 must be
	 ...
	 * retrieved with {@link #getPlainData()} or be directly saved to disk with
	 * {@link #savePlainDataToFile(String)}.
	 * 
	 ...
	 * </ul>
	 * According to the encryption algorithm, the {@link #setKeyMode(String)}
	 * method must be used, and a mandatory encryption key in base 64 must be
	 * introduced with {@link #setKey(String)}, or a password set by user with a
	 * modal dialog that will be displayed.</br> Operation's result may be
	 * retrieved with {@link #getPlainData()} or be directly saved to disk with
	 * {@link #savePlainDataToFile(String)}.
	 ...
	 * especificada en base64, igual que ser&aacute; obtenida mediante
	 * {@link #getKey()}.
	 * 
	 * @param newKey
	 *            Clave en base64.
	 ...
	 * contrase&ntilde;a debe ser una cadena ASCII v&aacute;lida.
	 * 
	 * 
	 * <br>
	 * <br>
	 ...
	 *         Returns <code>true</code> if password is valid. Else,
	 *         <code>false</code>.
	 * @see #setKeyMode(String)
	 * 
	 * 
	 ...
	 * Un formato de firma puede definir modos de firma propios.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * sea lo &uacute;ltimo que ocurra, en un fichero especificado.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * especificado mediante el m&eacute;todo {@link #addRecipientToCMS(String)}
	 * .
	 * 
	 * <br>
	 * <br>
	 ...
	 * digital envelope, as long as it was specified with
	 ...
	 * receptor) con los datos establecidos mediante {@link #setData(String)} o
	 * {@link #setFileuri(String)}. La configuraci&oacute;n del cifrado se
	 ...
	 * El algoritmo de cifrado se establecer&aacute; con
	 * {@link #setCipherAlgorithm(String)}, el modo de bloque y el relleno
	 ...
	 * almacenado en un fichero mediante {@link #saveCipherDataToFile(String)}.
	 * 
	 * 
	 * <br>
	 * <br>
	 ...
	 * information) with the data set with {@link #setData(String)} or
	 * {@link #setFileuri(String)}. Encryption configuration is set with
	 ...
	 * respectively. <br/>
	 * Results may be retrieved with {@link #getB64Data()} in binary or with
	 * {@link #getB64Data()} in base 64 and they may be stored in a file with
	 * {@link #saveCipherDataToFile(String)}.
	 * 
	 ...
	 * <br>
	 *             Replace with the content type's configuration with
	 *             {@link #setCMSContentType(String)} and the structure
	...
	/**
	 * Crea un objeto CMS AuthenticatedData con los datos establecidos mediante
	 * {@link #setData(String)} o {@link #setFileuri(String)}.
	 * 
	 * <br>
	 * <br>
	 * 
	 * Creates a CMS AuthenticatedData object with the data set with
	...
	/**
	 * Crea un objeto CMS envuelto utilizando los datos introducidos con
	 * {@link #setData(String)} o {@link #setFileuri(String)} y los certificados
	 ...
	 * El resultado se podr&aacute; recuperar en base64 mediante
	 * {@link #getB64Data()} y puede ser almacenado en un fichero mediante
	 * {@link #saveDataToFile()}.
	 * 
	 * <br>
	 * <br>
	 * 
	 * Creates an enveloped CMS object, using the data set with
	 * {@link #setData(String)} or {@link #setFileuri(String)} and the
	 ...
	 * will be set in the envelope if the sender certificate has been set with
	 * {@link #setSelectedCertificateAlias(String)}. Else, it will not be
	 * included. <br/>
	...
	/**
	 * Crea la estructura CMS del tipo indicado con
	 * {@link #setCMSContentType(String)}, por defecto "EnvelopedData".<br/>
	 * La estructura de datos se generar&aacute; a partir de los datons
	 * indicados mediante {@link #setData(String)} o {@link #setFileuri(String)}
	 * . Adicionalmente, cada estructura requiere la configuraci&oacute;n de los
	 * siguientes par&aacute;metros:<br/>
	 * <ul>
	 * <li><b>EncryptedData:</b> Estructura de datos cifrados simetricamente.
	 * Requiere establecer una configuraci&oacute;n de cifrado.</li>
	 * <li><b>EnvelopedData:</b> Estructura de datos envuelta (Sobre digital).
	 * Requiere que se le indiquen los destinatarios del mensaje y,
	 * opcionalmente, el remitente.</li>
	 * <li><b>SignedAndEnvelopedData:</b> Estructura de datos envuelta y firmada
	 * (Sobre digital firmado). Requiere que se le indiquen los destinatarios
	 * del mensaje y el remitente.</li>
	 * <li><b>AuthEnvelopedData:</b> Estructura de datos autenticada y envuelta
	 * (Sobre digital autenticado). Requiere que se le indiquen los
	 * destinatarios del mensaje y el remitente.</li>
	 * </ul>
	 * Los destinatarios se deber&aacute;n indicar mediante
	 * {@link #setRecipientsToCMS(String)} y/o
	 * {@link #addRecipientToCMS(String)} y
	 * {@link #removeRecipientToCMS(String)}. El emisor puede indicarse mediante
	 * {@link #setSelectedCertificateAlias(String)}. De no hacerlo y ser
	 ...
	 * <br>
	 * 
	 * Creates a CMS structure of the type indicated with
	 * {@link #setCMSContentType(String)}. Default content type is
	 * "EnvelopedData".<br/>
	 * Data structure will be generated from the data set with
	 * {@link #setData(String)} or {@link #setFileuri(String)}. Moreover, each
	 * structure requires the configuration of the following parameters:<br/>
	 * <ul>
	 * <li><b>EncryptedData:</b> Symmetrically encrypted data structure.
	 * Requires setting an encryption configuration.</li>
	 * <li><b>EnvelopedData:</b> Enveloped data structure (Digital envelope).
	 * Requires message recipients and (optionally) the sender to be set.</li>
	 * <li><b>SignedAndEnvelopedData:</b> Enveloped and signed data structure
	 * (Signed digital envelope). Requires message's sender and recipients to be
	 * set.</li>
	 * <li><b>AuthEnvelopedData:</b> Authenticated and enveloped data structure
	 * (Authenticated digital envelope). Requires messages's recipients and
	 * sender to be set.</li>
	 * </ul>
	 * Recipients must be indicated with {@link #setRecipientsToCMS(String)}
	 * and/or {@link #addRecipientToCMS(String)} and
	 * {@link #removeRecipientToCMS(String)}. Sender may be indicated with
	 * {@link #setSelectedCertificateAlias(String)}. If no sender is indicated
	 ...
	 * <ul>
	 * <li><b>EncryptedData:</b> Estructura de datos cifrados
	 * sim&eacute;tricamente.</li>
	 * <li><b>EnvelopedData:</b> Estructura de datos envuelta (Sobre digital).</li>
	 * <li><b>SignedAndEnvelopedData:</b> Estructura de datos envuelta y firmada
	 * (Sobre digital firmado).</li>
	 * <li><b>AuthEnvelopedData:</b> Estructura de datos autenticada y envuelta
	 * (Sobre digital autenticado)</li>
	 * </ul>
	 * <br>
	 * <br>
	 ...
	 * <li><b>SignedAndEnvelopedData:</b> Enveloped and Signed Data Structure
	 * (Signed digital envelope).</li>
	 * <li><b>AuthEnvelopedData:</b> Authenticated and enveloped data structure
	 * (Authenticated digital envelope)</li>
	 * </ul>
	 * 
	 * @param contentType
	 ...
	 * cifr&oacute; con contrase&ntilde; o clave mediante el m&eacute;todo
	 * {@link #setKeyMode(String)}, y esta con {@link #setPassword(String)} o
	 * {@link #setKey(String)}, respectivamente. <br/>
	 * En el caso de los sobres <code>EnvelopedData</code> y
	 * <code>SignedAndEnvelopedData</code> se puede indicar el certificado para
	 * descifrar mediante el m&eacute;todo
	 * {@link #setSelectedCertificateAlias(String)}. <br/>
	 * El resultado se podr&aacute; recuperar en base64 mediante
	 * {@link #getB64Data()} y puede ser almacenado en un fichero mediante
	 * {@link #saveDataToFile()}.
	 * 
	 ...
	 * whether password or key was used for encryption with
	 * {@link #setKeyMode(String)} method. In turn, these may be set with
	 * {@link #setPassword(String)} or {@link #setKey(String)}, respectively. <br/>
	 * In case of <code>EnvelopedData</code> and
	 * <code>SignedAndEnvelopedData</code> envelopes certificate for decryption
	...
	/**
	 * Firma y empaqueta en un sobre digital los datos especificados por
	 * {@link #setData(String)} o {@link #setFileuri(String)} El resultado puede
	 * ser recuperado mediante {@link #getB64Data()}
	 * 
	 * <br>
	 * <br>
	 * 
	 * Signs and packs in a digital envelope the digital data specified by
	 * {@link #setData(String)}. Results can be retrieved with
	 ...
	 * resultado puede ser recuperado mediante {@link #getB64Data()}.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * <br>
	 * 
	 * Add a new sender in a digital envelope specified with
	 * {@link #setData(String)} or {@link #setFileuri(String)}. Results can be
	 ...
	 * LDAP. La direcci&oacute;n del LDAP es obligatoria.
	 * 
	 * 
	 * <br>
	 * <br>
	 ...
	 * LDAP y los requisitos para identificar al certificado en cuesti&oacute;n.
	 * 
	 * <br>
	 * <br>
	 ...
	 * contrario. El directorio de firma se puede establecer con
	 * {@link #setInputDirectoryToSign(String)}, si no se hace, se
	 ...
	 * de los subdirectorios del directorio establecido, debe usarse
	 * {@link #setInRecursiveDirectorySign(boolean)}. Es posible limitar los
	 * ficheros que deben firmarse mediante un filtro establecido con
	 * {@link #setInIncludeExtensions(String)}. <br/>
	 ...
	 * El tipo de operaci&oacute;n se indica mediante
	 * {@link #setMassiveOperation(String)}. <br/>
	 * Si no se indica un directorio de salida con
	 * {@link #setOutputDirectoryToSign(String)} el resultado se
	 ...
	 * directorio de salida de firmas y se devolver&aacute; <code>false</code>
	 * para que se realicen las operaciones adecuadas.
	 * 
	 * 
	 * <br>
	 * <br>
	 ...
	 * a dialog will be displayed, prompting the selection of a directory.
	 * {@link #setInRecursiveDirectorySign(boolean)} must be used to indicate
	 * that subdirectory files are also meant for signing. A limit may be
	 * established on the files to be signed with a filter set with
	 * {@link #setInIncludeExtensions(String)}. <br/>
	 ...
	 * If no output directory is indicated with
	 * {@link #setOutputDirectoryToSign(String)} results will be saved in the
	 ...
	 * por los m&eacute;todos {@link #signDirectory()},
	 * {@link #massiveSignatureData(String)} y
	 * {@link EntryPointsCrypto#massiveSignatureFile(String)}. <br/>
	 ...
	 * the {@link #signDirectory()}, {@link #massiveSignatureData(String)} and
	 * {@link EntryPointsCrypto#massiveSignatureFile(String)} methods. <br/>
	 * The massive operations are:
	 * <ul>
	 * <li>FIRMAR: Sign.</li>
	 * <li>COFIRMAR: Cosign.</li>
	 * <li>CONTRAFIRMA_ARBOL: Countersign of all nodes from the signature tree.</li>
	 * <li>CONTRAFIRMA_HOJAS: Countersign of all leaves nodes from the signature
	 * tree.</li>
	 * </ul>
	 * 
	 ...
	 * defecto, se respeta el formato original.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * firmas resultado de la operaci&oacute;n de firma masiva.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * <br>
	 * 
	 * Sets the output directory where massive signatures of files located in
	 * <code>InputDirectoryToSign</code> will be saved.
	 * 
	 * @param directory
	 *            Ruta absoluta del directorio. <br>
	 *            Absolute route of the directory.
	 ...
	 * exctensi&ioacute;n, introducir <code>null</code>. Por ejemplo:
	 * <code>TXT,JPG,BMP,DAT</code>
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * filtering, <code>null</code> must be entered. Example:
	 * <code>TXT,JPG,BMP,DAT</code>
	 * 
	 * 
	 * @param extensions
	 ...
	 *            <code>true</code> to sign a directory and its subdirectories.
	 ...
	 * <li>Operaci&oacute;n masiva a realizar (firma, cofirma, contrafirma de
	 * hojas o de &aacute;rbol).</li>
	 * </ul>
	 ...
	 * configuraci&oacute;n del procedimiento.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * <li>Massive operation to execute (sign, cosign, counter-sign leaves or
	 * tree).</li>
	 * </ul>
	 ...
	 * {@link #endMassiveSignature()} to eliminate the procedure's
	 * configuration.
	 * 
	 * 
	 ...
	 * contrafirma se indicar&aacute; la firma con la que se operar&aacute;.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * de firma masiva (ni cofirmas, ni contrafirmas).
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * la firma que se desea contrafirmar.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * <li><b>P11</b>: Repositorio de tipo PKCS#11 controlador por una libreria
	 * de sistema.</li>
	 ...
	 * <li><b>WINDOWS-CA</b>: Repositorio de Autoridades Intermedias de
	 * Certificaci&oacute;n de Windows.</li>
	 ...
	 * <li><b>P11</b>: Type PKCS#11 repository, controlled by a system's
	 * library.</li>
	 ...
	 * <li><b>WINDOWS-CA</b>: Windows Intermediate Certification Authorities
	 * Repository.</li>
	 ...
	 */
	public void setPolicy(String identifier, String description,
			String qualifier);
	 ...
	 * {@link es.gob.afirma.cliente.SignApplet#STRING_SEPARATOR}.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * returns them as a single string with aliases separated by
	 * {@link es.gob.afirma.cliente.SignApplet#STRING_SEPARATOR}
	 * 
	...
	/**
	 * Obtiene todos los alias de los certificados disponibles para firmar o
	 * cifrar y los devuelve en un array.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 *            bit are displayed for selection. If set to <code>false</code>
	 *            all certificates are displayed.
	 * @see #setMandatoryCertificateConditionRFC2254(String, String, boolean)
	 */
	public void setCertFilterRFC2254(String subjectFilter, String issuerFilter,
			boolean onlySignatureCertificates);
	 ...
	 * @see #setCertFilterRFC2254(String, String, boolean)
	 */
	public void setMandatoryCertificateConditionRFC2254(String subjectFilter,
			String issuerFilter, boolean onlySignatureCertificates);
	 ...
	 * m&eacute;todos {@link #getSignCertificate()} y
	 ...
	 * recovered with {@link #getSignCertificate()} and
	 * {@link #getSignCertificateBase64Encoded()}.
	 * 
	 * 
	 ...
	 * este tipo se devuelve cadena vac&iacute;a.
	 * 
	 * <br>
	 * <br>
	 * 
	 ...
	 * 
	 * @return Las firmas en base64 separadas unas de otras por el signo de
	 *         cierre de admiraci&oacute;n (!) <br>
	 *         Signatures in base 64, separated by an exclamation mark.
