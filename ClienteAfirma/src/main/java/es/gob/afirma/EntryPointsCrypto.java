 ...
 * <br><br>
 * Contains AFirma cryptographic functionalities access points, for their use as Applet Java.
 */
public interface EntryPointsCrypto {
	 ...
	 * <dl>
	 *  <dt>
	 *   For the selection of certificates (optional, exclusive), if none is specified, a window is displayed
	 *   prompting the user to choose among already installed certificates. 
	 *  </dt>
	 *  <dd>
	 *   <ul>
	 *    <li>mandatoryCertCondition</li>
	 ...
	 *  </dd>
	 *  <dt>
	 *   For the selection of input data (optional, exclusive): if none is specified, 
	 *   a window is displayed, prompting the user to select the file to be signed.
	 *  </dt>
	 *  <dd>
	 *   <ul>
	 *    <li>data</li>
	 ...
	 *  </dd>
	 *  <dt>
	 *   For electronic signature (optional): If none are specified, default values are used. 
	 *  </dt>
	 *  <dd>
	 *   <ul>
	 *    <li>signatureAlgorithm</li>
	 ...
	 * <br> <code>true</code> if execution is correct, else <code>false</code>.
	 */
	public boolean sign();

	/**
	 * Firma los datos proporcionados en base 64.
	 * <br><br> Signs provided data in base 64. 
	 * 
	 * @param b64data Datos a firmar, en formato Base64.
	 * <br> Data to be signed, in Base64 format.
	 * @return <code>true</code> si &eacute;xito, <code>false</code> si ocurri&oacute; alg&uacute;n fallo
	 * <br> <code>true</code> if successful, <code>false</code> in case of failure.
	 ...
	 * <br> This method is kept to secure compatibility with v.4 and former versions of the @firma platform.
	 * @param   datos Datos codificado en base 64.
	 * <br> data encoded in base 64.
	 * @return  Cadena que contiene el certificado y los datos firmados 
	 *          todo codificado en base 64.
	 *          <br> String containing the certificate and signed data, both encoded in base 64.
	 */
	 ...
	 * <br><br> Adds a signed attribute to the selected signature format. This format must recognize the 
	 * specified OID. Attribute {@code value} is its value as a text string.
	 * @param oid Object Identifier. Identificador del objeto a introducir.
	 * <br> Object Identifier
	 * @param value Valor asignado
	 * <br> Assigned value
	 * @return true si se ha realizado correctamente.
	 * <br> true if successful.
	 */
	...
	/**
	 * Elimina el atributo con el OID indicado antes de realizar la firma.
	 * <br> Eliminates the attribute with the indicated OID before signing.
	 * @param oid Object Identifier.
	 * @param value Valor especifico a borrar.
	 * <br> Specific value to be eliminated.
	 * @return true si se ha eliminado correctamente. False si no exist&iacute;a o ha ocurrido alg&uacute;n error.
	 * <br> true if successfully eliminated. False if nonexistent, or error occurred.
	 */
     ...
     * <br><br> Includes an additional property to the signature configuration.
     * @param key Propiedad que se desea establecer.
     * <br>Property to be included.
     * @param value Valor que se desea establecer a la propiedad.
     * <br> Value for the property to be included.
     * 
     */
     ...
     * <br><br> Eliminates an additional property from the signature configuration.
     * @param key propiedad que se desea eliminar.
     * <br> property to be eliminated.
     */
     ...
     * <br><br>
     * Includes a new XML transformation to the client's configuration. 
     * This transformation will be considered by those signature formats that 
     * allow the configuration of  XML transformations to be applied on the data.<br/>
     * This method may be used several times in order to establish that a set of transformations be applied 
     * to the signatures following a pre-arranged scheme.
     * There are several types of transformations. In turn, some types have subtypes.
     * Established types and subtypes are:
     * <br>
     * <ul>
     ...
     * <br><br>Eliminates all XML transformations configured in the client.
     */
	 ...
	 * <br><br>
	 * Performs a parallel cosignature process. Available operative parameters and methods are:<br>
	 * <ul>
	 ...
	 * </ul>
	 * </ul>
	 * Parameters established as result of this operation are:
	 * <ul>
	 ...
	 *  <br> <code>true</code> if the operation ended successfully. Else, <code>false</code>.
	 */
	 ...
	 * </ul>
	 * Signature may be set with {@link #setElectronicSignature(String)} or
	 * {@link #setElectronicSignatureFile(String)}. Signature analysis is performed 
	 * first by means of the Signature Format Administrator established with 
	 * {@link #setSignatureFormat(String)} and, in case it provides no support for the 
	 * intoduced signature, a suitable administrator shall be sought.  
	 ...
	 * <br> A string representing signature structure (parallel and cascade)
	 */
	 ...
	 * 
	 * 
	 * Performs the counter-signature process (cascade signature). Counter-signs all nodes from one
	 * or more signers.<br>
	 * <br>
	 * <b>Input parameters:</b><br>
	 * - Certificate selection (optional, exclusive): if unspecified, a window is displayed, prompting 
	 * the user to choose among installed certificates<br>
	 * <pre>    - mandatoryCertCondition</pre>
	 * <pre>    - certFilter</pre>
	 * - For electronic signature (optional): If unspecified, default values are used<br>
	 * <pre>    - signatureAlgorithm</pre>
	 * <pre>    - signatureFormat</pre>
	 ...
	 * <pre>    - signersToCounterSign (signers names returned by getSignersStructure() separated by '\n' )</pre>
	 * <br>
	 ...
	 * <pre>    - signatureBase64Encoded</pre>
	 * <pre>    - fileUsedPath (if data to be signed has been read from a file) </pre>
	 * <pre>    - signCertificateBase64Encoded</pre>
	 * <br><br>
	 * @see #setMandatoryCertificateCondition(String)
	 * @see #setCertFilterRFC2254(String, String, boolean)
	 ...
	 * 
	 * 
	 * Performs the counter-signature process (cascade signature). Counter-signs nodes
	 * with specific indexes.<br>
	 * <br>
	 * <b>Input parameters:</b><br>
	 * - For certificate selection (optional, exclusive): If unspecified, a window is displayed prompting user to choose
	 * among all installed certificates<br>
	 * <pre>    - mandatoryCertCondition</pre>
	 * <pre>    - certFilter</pre>
	 * - For electronic signature (optional): If unspecified, default values are used. <br>
	 * <pre>    - signatureAlgorithm</pre>
	 ...
	 * <pre>    - electronicSignatureFile</pre>
	 * - Signers to counter-sign:
	 * <pre>    - signersToCounterSign (Node index from  getSignersStructure() separated by '\n')</pre>
	 * <br>
	 * <b>Output parameters:</b><br>
	 * - If error occurs (isError()==true):<br>
	 * <pre>    - errorMessage</pre>
	 ...
	 * <br> Returns <codetrue</code> if operation ends successfully. Else, false.
	 * @see #setMandatoryCertificateCondition(String)
	 * @see #setCertFilterRFC2254(String, String, boolean)
	 * @see #setData(String)
	 * @see #setFileuri(String)
	 ...
	 * 
	 * 
	 *  Performs the counter-signature process (cascade signature). Counter-signs all nodes in tree. 
	 * <br>
	 * <b>Input parameters:</b><br>
	 * - For certificate selection (optional, exclusive): If unspecified, a window is displayed prompting user to choose
	 * among all installed certificates<br>
	 ...
	 * <br>
	 * 
	 * Performs  counter-signature process (cascade signature). Counter-signs tree leaves.<br>
	 * <br>
	 * <b>Input parameters:</b><br>
	 * - For certificate selection (optional, exclusive): If unspecified, a window is displayed prompting user to choose
	 * among all installed certificates<br>
	 ...
	 * <br><br>
	 * Stores a previously generated electronic signature in a file. Signature has been 
	 * generated by a signature, cosignature or counter-signature operation. Storage route is set 
	 * with {@link #setOutFilePath(String)}. If no storage route has been set, a Save dialog box is displayed.
	 * @return true si el proceso termina correctamente, false en otro caso.
	 * <br>true if process ends successfully. Else, false.
	 */
	 ...
	 * 
	 * <br><br>
	 * Returns the base 64 certificate which has been used for signing. This operation returns the last 
	 * certificate loaded in the signature operation. A failed signature operation results in a reference to 
	 * a certificate that may not be the one used in the last satisfactory operation. If no certificate has been selected
	 * an empty string is returned. 
	 * @return El certificado de firma en base 64.
	 * <br> The signature certificate in base 64.
	 */
	public String getSignCertificateBase64Encoded();

	/**
	 * Devuelve el certificado con el que se ha firmado o ensobrado datos. Esta operaci&oacute;n
	 * devuelve el &uacute;ltimo certificado cargado durante una operacion de firma o envoltura de
	 * datos. Una operaci&oacute;n de firma fallida tras la selecci&oacute;n del certificado lleva a
	 * devolver la referencia a un certificado que puede no ser el utilizado en la &uacute;ltima
	 * operacion de firma satisfactoria.
	 * En caso de no haber ning&uacute;n certificado seleccionado se devolver&aacute; <code>null</code>.  
	 * 
	 * <br><br>
	 *  
	 * Returns the certificate which has been used for signing or enveloping. This operation returns the last 
	 * certificate loaded in the signature operation. A failed signature operation results in a reference to 
	 * a certificate that may not be the one used in the last satisfactory operation. If no certificate has been selected
	 ...
	 * <li><code>SHA1withRSA</code> (Recomendado)</li>
	 * <li><code>SHA256withRSA</code></li>
	 * <li><code>SHA384withRSA</code></li>
	 * <li><code>SHA512withRSA</code></li>
	 * </ul>
	 * Se desaconsejan los algoritmos MD2 y MD5 por motivos de obsolescencia. Algunos formatos
	 * de firma y algunos almacenes de certificados no soportan todos los algoritmos.
	 * 
	 * <br><br>
	 * 
	 ...
	 * <li><code>MD2withRSA</code></li>
	 * <li><code>MD5withRSA</code></li>
	 * <li><code>SHA1withRSA</code> (Recommended)</li>
	 * <li><code>SHA256withRSA</code></li>
	 * <li><code>SHA384withRSA</code></li>
	 * <li><code>SHA512withRSA</code></li>
	 * </ul>
	 * The use of MD2 and MD5 algorithm's obsolescence.
	 * Some signature formats and some keystores do not support all algorithms.  
	 * 
	 * @param signatureAlgorithm Nombre del algoritmo a usar en las operaciones de firma.
	 * <br> Algorithm name to be used in signature operations.
	 */
	 ...
	 * <br> Electronic signature's format to be generated. 
	 */
	 ...
	 * <br> Base64 string, with the encrypted text.
	 */
	 ...
	 * 
	 * <br><br>
	 * Returns the plain data that has been introduced to encrypt, or the text resulting from a decryption 
	 *  (whichever comes last). If none of this conditions are met, <code>null</code> is returned. 
	 * @return String Texto plano de la operaci&oacute;n de cifrado / descifrado.
	 * <br> Plain text string of the encryption/decryption operation.
	 * @see #decipherData()
	 ...
	 * <br><br>
	 * 
	 * Sets the route to the file where the operation's resulting data will be stored.
	 * 
	 * @param outFilePath Ruta por defecto del fichero de salida.
	 * <br> Output file's default route.
	 */
	 ...
	 * <br><br>
	 * 
	 * Returns the signature generated in the last signature process, or set by the client as a 
	 * string (useful for XAdES, XMLDSign and web signatures). If no signature has been generated, 
	 * an empty string is returned. <br/>
	 * The use of this method is discouraged, since returned results may vary depending on the 
	 * encryption set by default. Its main use is showing the results of a XML signature. For binary signatures
	 * {@link #getSignatureBase64Encoded()} should be used.
	 * 
	 * If no signature is available, an empty string is returned.
	 * 
	 * 
	 ...
	 * <br> Last generated (or user set) electronic signature. 
	 */
	 ...
	 * <br><br>
	 * 
	 * Sets input data in base 64 for the signature, cosignature (parallel signature) and counter-signature
	 *  and digital envelope generation processes.
	 * <br/>Data entered with this function will overwrite any other which 
	 * may have been previously set with setFileuri or setHash methods.
	 * 
	 * @param data Datos a operar codificados en base 64.
	 * <br> Data to operate with, encrypted in base 64.
	 * @see #setHash(String)
	 * @see #setFileuri(String)
	 */
	 ...
	 * 
	 * 
	 * Sets the URI (or URL) pointing to the file which contains input data to operate (i.e., encrypt, sign, read, etc.) with.
	 * <code>file://</code> protocol is supported, for locally stored files. 
	 * <br/>Data entered with this function will overwrite any other which 
	 * may have been previously set with setData o setHash methods.
	 * 
	 * 
	 * @param fileuri URI hacia el fichero de datos.
	 * <br> URI to the data file.
	 * @see #setData(String)
	 * @see #setHash(String)
	 ...
	 * <br><br>
	 * 
	 * Sets the data contained in the indicated base 64-encrypted file as the input data for
	 * cryptographic operations, and sets the indicated route as input route.<br/>
	 * Contents of the file will always be interpreted as base 64 data. They will not be checked.
	 * 
	 * @param fileuri URI hacia el fichero de datos.
	 * <br> URI to the data file.
	 * @see #setFileuri(String)
	 ...
	 *<br><br>
	 *
	 * Sets the hash to the data to be signed for the signature processes. 
	 * <br/>This entry will have maximum priority when an explicit signature is performed.
	 * 
	 ...
	 * <br><br>
	 * 
	 * Route to the file where the signature has been stored. This address may have been set programmatically 
	 * by {@link #setOutFilePath(String) setOutFilePath} or by the interface showing when there is no 
	 * assigned value. Once the output file's value is set, it remains unchanged, even in cases where the signature operation
	 * may not be complete. If there is no set output file, an empty string is returned.
	 * 
	 * @return Ruta al fichero en que se ha guardado la firma.
	 * <br> Route to the file containing the signature.
	 */
	public String getFilePath();

	/**
	 * Devuelve la ruta del fichero de entrada. Esta direcci&oacute;n puede haberse
	 ...
	 * <br><br>
	 * 
	 * Returns the input file's path. This address may have been set programmatically
	 * by {@link #setFileuri(String) setFileuri} or or by the interface showing when there is no 
	 * assigned value. Once the file's value is set, it remains unchanged, even in cases where the signature operation
	 * may not be complete. If there is no set output file, an empty string is returned.<br/>
	 * The file's path will be returned observing <i>URL Encoding</i>, i.e., changes will be executed
	 * such as replacing (' ') by "%20". This method does not allow directly acquiring
	 * a file by the class {@link java.io.File}. An URI must be previously acquired.
	 * 
	 * @return Fichero que seleccion&oacute; el usuario para firmar
	 * <br> File selected by the user for signature.
	 */
	 ...
	 * <br><br>
	 * 
	 * Sets an electronic signature in base 64 as input for the signature client.
	 * This method is mainly used to indicate the electronic signature during every type of 
	 * cosignature and counter-signature operations.
	 * 
	 * @param inElectronicSignature Firma electr&oacute;nica en base 64.
	 * <br> Electronic signature in base 64.
	 */
	 ...
	 * <br><br>
	 * 
	 * Sets the route to an electronic signature file as input for the signature client. 
	 * This method is mainly used to indicate electronic signature during every type of 
	 * cosignature and counter-signature operations.
	 * 
	 * 
	 * @param inElectronicSignatureFile Ruta del fichero de firma.
	 * <br> Route to the signature file.
	 */
	 ...
	 * <br><br>
	 * 
	 * Sets the nodes to counter-sign in signers and nodes' counter-signature operations. 
	 * When a specific signer's counter-signature is to be performed, 
	 * signers names will be indicated in the way returned by {@link #getSignersStructure()}. 
	 * In case of nodes' counter-signature, nodes' indexes (where first node is 0). Different elements 
	 * are consecutively indicated as a string and separated by '\n' or '\r\n'. Nodes will only be 
	 * counter-signed once for each operation. Thus, repeating signers or nodes will have no effect on the operation. 
	 * 
	 * @param signers Cadena de nombres de firmantes o &iacute;ndices de los nodos.
	 * <br> Signer names string or node indexes.
	 */
	 ...
	 * <br><br>
	 * 
	 * Stores data originating in the function previously performed on a specified file.
	 * 
	 * 
	 * @param fileUri Ruta del fichero destino.
	 * <br> Route to the destination file.
	 * @return <code>true</code> si los datos se han guardado correctamente, <code>false</code> en caso contrario.
	 * <br> <code>true</code>  if data has been stored successfully. Else, <code>false</code>.
	 */
	 ...
	 * <br><br>
	 * 
	 * Defines the type of entered mime data. If a file is specified, it will be automatically attempted to obtain mimetype from 
	 * the file's extension. If no file is specified, and mimetype cannnot be automatically obtained, application/octet-string 
	 * will be regarded as default mimetype.
	 *   
	 * @param mimetype Tipo de datos para los datos actuales.
	 * <br> Type of data, for current data.
	 */
	 ...
	 * <br><br>
	 * 
	 * Shows and signs an HTML (web signature)
	 * 
	 * @param html HTML a mostrar y firmar
	 * <br>HTML to be shown and signed.
	 ...
	 * <br><br>
	 * 
	 * Encrypts indicated data by setPlainData(String) method. If no encryption algorithm, block mode and padding is indicated, 
	 * default configuration will be used. Key mode can be set with {@link #setKeyMode(String)}, if either 
	 * self-generated, manual, or password key is desired.  Data can be retrieved with 
	 * {@link #getCipherData()} and stored to disk with {@link #saveCipherDataToFile(String)}.

	 * 
	 * @return true si la operaci&oacute;n se realiz&oacute; con &eacute;xito, false en caso contrario.
	 * <br> true if operation successful. Else, false.
	 */
	 ...
	 * con {@link #setFileuri(String)}. No puede recuperarse la ruta de fichero mediante
	 * getFileUsedPath().
	 * 
	 * <br><br>
	 * 
	 * Encrypts the specified file. This operation's result is equivalent to executing 
	 * {@link #cipherData()} method, after indicating a file with {@link #setFileuri(String)}.
	 * The file’s path can’t recovered using getFileUsedPath() method.
	 * 
	 * @param fileUri Fichero de datos a cifrar
	 * <br> Data file to encrypt.
	 * @return true si la operaci&oacute;n se efectu&oacute; con &eacute;xito
	 * <br> true if operation successful. 
	 */
	 ...
	 * with the {@link #setCipherData(String)} method or, if a file, with {@link #setFileuri(String)}. 
	 * Encryption configuration used for the data must be indicated with {@link #setCipherAlgorithm(String)} method
	 * which may contain the encryption algorithm only, or the complete encryption algorithm configuration, block mode, and padding, 
	 * with data separated by a slash ('/'). E.g.:
	 * <ul>
	 * <li>AES</li>
	 * <li>AES/ECB/PKCS5PADDING</li>
	 * </ul>
	 * According to the encryption algorithm, the {@link #setKeyMode(String)} must be used, and a mandatory encryption key in base 64
	 *  must be introduced with {@link #setKey(String)}, or a password set by user with a modal dialog that will be displayed.</br>
	 * Operation's result may be retrieved with {@link #getPlainData()} or be directly saved to disk with {@link #savePlainDataToFile(String)}.
	 * 
	 ...
	 * <br><br>
	 * 
	 * Decrypts indicated file. Encryption configuration used for data
	 * must be indicated with {@link #setCipherAlgorithm(String)} method, 
	 * which may include the encryption algorithm only, or the complete encryption algorithm configuration, 
	 * block mode and padding, with data separated by a slash ('/').
	 * Example:
	 * <ul>
	 * <li>AES</li>
	 * <li>AES/ECB/PKCS5PADDING</li>
	 * </ul>
	 * According to the encryption algorithm, the {@link #setKeyMode(String)} method must be used, and a mandatory encryption key in base 64
	 *  must be introduced with {@link #setKey(String)}, or a password set by user with a modal dialog that will be displayed.</br>
	 * Operation's result may be retrieved with {@link #getPlainData()} or be directly saved to disk with {@link #savePlainDataToFile(String)}.
	 * 
	 * @param fileUri Archivo de datos a descifrar
	 * <br>Data file to decrypt.
	 * @return true si la operaci&oacute;n finaliz&oacute; con &eacute;xito, false en caso contrario.
	 * <br> true if operation successful. Else, false.
	 */
	 ...
	 *  <br><br>
	 *  
	 * Returns the current encryption key in Base64.
	 * Si an action has just been executed, the key for this action will be returned. Else, the input key (in case of 
	 * manual key) or null will be returned.
	 ...
	 * <br><br>
	 * 
	 * Sets the text string used as password for data encryption. The use of this method requires setting the key mode 
	 * for password use, and an encryption algorithm suitable for use with passwords. 
	 * Password must be a valid ASCII string.
	 * 
	 * @param password Cadena de texto usada como contrase&ntilde;a.
	 * <br>Text string used as password.
	 * @return Devuelve <code>true</code> si la contrase&ntilde;a es v&aacute;lida, <code>false</code>
	 * en caso contrario.
	 * <br>Returns <code>true</code> if password is valid. Else, <code>false</code>.
	 * @see #setKeyMode(String)
	 * 
	 * 
	 */
	 ...
	 * <br><br>
	 * 
	 * Returns the text string used as a password in the last encryption operation.
	 * 
	 * 
	 * @return String Password o, si no se ha establecido una, nulo.
	 * <br> String password or, if none, null.
	 */
	 ...
	 * It may be used in both simple encryptions as in the generation of digital envelopes.<br/>
	 * If key mode and padding configuration are required by the algorithm, they may be provided next to its 
	 * name, separated by '/' with the format:
	 * <pre>      <code>Algorithm/Mode/Padding</code></pre>
	 * Example:
	 * <pre>      <code>AES/ECB/PKCS5PADDING</code></pre>
	 * <br/>
	 ...
	 * <br> Symmetric encryption algorithm
	 * @see #cipherData()
	 ...
	 * <br><br>
	 * 
	 * Sets the signature mode defining whether data will be embedded or not in a generated signature. 
	 * It may be, respectively, explicit or implicit. Options are not case sensitive.  
	 * 	<br/>A signature format may define its own signature modes.
	 * 
	 ...
	 * Los modos de obtenci&oacute;n de clave son:
	 * <ul>
	 ...
	 * 
	 * <br><br>
	 * Defines the mode of acquiring a symmetric encryption/decryption key.
	 * Key acquiring modes are:
	 * <ul>
	 ...
	 * <br>Route to the storage file.
	 * @return Devuelve <code>true</code> si se ha realizado con &eacute;xito.
	 * <br>Returns <code>true</code> if successful.
	 * 
	 */
	 ...
	 * <br><br>
	 * 
	 * Saves the data decrypted during a previous decryption operation or a previously entered plain text
	 * (whichever comes last) in a specified file.
	 * 
	 * @param fileUri Ruta del fichero donde guardar la informaci&oacute;n en plano.
	 * <br> Route to the file where information is to be stored, in plain text.
	 * @return true si los datos se guardaron correctamente.
	 * <br>true if data was saved successfully. 
	 */
	 ...
	 * 
	 * Sets whether or not user may store encrption keys in the associated keystore.
	 * 
	 * @param useKeyStore Indica si se debe usar el almacen de claves.
	 * <br> Indicates whether or not the keystore mut be used.
	 */
	public void setUseCipherKeyStore(boolean useKeyStore);
	
	//*******************************************************************/
	//************** FUNCIONALIDADES DE SOBRE DIGITAL  ******************/
	//************* DIGITAL ENVELOPE'S FUNCTIONALITIES ******************/
	//*******************************************************************/
	 ...
	 * <br><br>
	 * 
	 * Defines the location of certificates that will be used as digital envelope's recipients.
	 * 
	 * @param recipientsCertPath Cadena de rutas a los ficheros, separados por 'retornos de l&iacute;nea' ('\n').
	 * <br>String of routes to the files, separated by 'returns' ('\n').  
	 */
	 ...
	 * <br><br>
	 * 
	 * Adds a new recipient to list of recipients that will be sent a digital envelope, 
	 * using the former's certificate. This recipient is added to those specified 
	 * with {@link #setRecipientsToCMS(String)}. Thus, the use of this method does not affect 
	 * certificates introduced using that function, and viceversa. To eliminate a certificate
	 * added to the list with this method, {@link #removeRecipientToCMS(String)} must be used.
	 * 
	 * @param certB64 Certificado en base 64.
	 * <br> Certificate in base 64.
	 */
	 ...
	 * <br><br>
	 * 
	 * Eliminates a recipient from the list of recipients that will be sent a digital envelope,
	 * as long as it was specified with {@link #addRecipientToCMS(String)}.
	 * 
	 * @param certB64 Certificado en base 64 del destinatario que deseamos eliminar.
	 * <br> Certificate in base 64, for the recipient desired for ellimination.
	 */
	 ...
	 * 
	 * 
	 * Creates an encrypted CMS object (w/o key, sender or recipient information) with the data 
	 * set with {@link #setData(String)} or {@link #setFileuri(String)}. Encryption configuration is set 
	 * with {@link #setKeyMode(String)} to select the kind of encryption (key or password) and - if the default 
	 * option of key is used - it will be mandatory that a key be set with {@link #setKey(String)}. In contrast, 
	 * passwords will always be requested via a client's propietary interface. No programmatic introduction is 
	 * possible. 
	 * <br/>The encryption algorith is set with {@link #setCipherAlgorithm(String)}, block mode and fill 
	 * will always be "CBC" y "PKCS#5 Padding", respectively.
	 * <br/>Results may be retrieved with {@link #getB64Data()} in binary or with
	 * {@link #getB64Data()} in base 64 and they may be stored in a file with  {@link #saveCipherDataToFile(String)}.
 	 * 
	 * @return <code>true</code> si la operaci&oacute;n se ha realizado con &eacute;xito.
	 * <br> <code>true</code>, if successul.
	 * @see #saveDataToFile()
	 * 
	 * @deprecated Sustituir por la configuraci&oacute;n del tipo de contenido con
	 * {@link #setCMSContentType(String)}} y la generaci&oacute;n de la estrutura
	 * mediante {@link #buildCMSStructure()}.
	 * <br><br>
	 * Replace with the content type's configuration with {@link #setCMSContentType(String)}}
	 * and the structure generation with {@link #buildCMSStructure()}.
	 */
	@Deprecated
	 ...
	 * <br><br>
	 * 
	 * Creates a CMS AuthenticatedData object with the data set with {@link #setData(String)} 
	 * or {@link #setFileuri(String)}.
	 * 
	 * @return <code>true</code> si la operaci&oacute;n se ha realizado con &eacute;xito, <code>false</code>
	 *         en caso contrario.
	 *         <br><code>true</code> if successful. Else, <code>false</code>.
	 * @see #saveDataToFile()
	 * 
	 * @deprecated Sustituir por la configuraci&oacute;n del tipo de contenido con
	 * {@link #setCMSContentType(String)}} y la generaci&oacute;n de la estrutura
	 ...
	 * <br><br>
	 * 
	 * Creates an enveloped CMS object, using the data set with {@link #setData(String)} or 
	 * {@link #setFileuri(String)} and the certificates indicated with {@link #setRecipientsToCMS(String)} 
	 * as recipients. It is mandatory to set at least one recipient. Sender data will be set in the 
	 * envelope if the sender certificate has been set with 
	 * {@link #setSelectedCertificateAlias(String)}. Else, it will not be included.
	 * <br/>Results may be retrieved in base 64 with {@link #getB64Data()} and  
	 * may be stored in a file with {@link #saveDataToFile()}.
	 * 
	 ...
	 * <br><br>
	 * 
	 * Creates a CMS structure of the type indicated with {@link #setCMSContentType(String)}. 
	 * Default content type is "EnvelopedData".<br/>
	 * Data structure will be generated from the data set with 
	 * {@link #setData(String)} or {@link #setFileuri(String)}.
	 * Moreover, each structure requires the configuration of the following parameters:<br/>
	 * <ul>
	 * <li><b>EncryptedData:</b> Symmetrically encrypted data structure. Requires setting an encryption
	 * configuration.</li>
	 * <li><b>EnvelopedData:</b> Enveloped data structure (Digital envelope). Requires
	 * message recipients and (optionally) the sender to be set.</li>
	 * <li><b>SignedAndEnvelopedData:</b> Enveloped and signed data structure (Signed digital envelope).
	 * Requires message's sender and recipients to be set.</li>
	 * <li><b>AuthEnvelopedData:</b> Authenticated and enveloped data structure (Authenticated 
	 * digital envelope). Requires messages's recipients and sender to be set.</li>
	 * </ul>
	 * Recipients must be indicated with {@link #setRecipientsToCMS(String)} and/or
	 * {@link #addRecipientToCMS(String)} and {@link #removeRecipientToCMS(String)}. Sender may
	 * be indicated with {@link #setSelectedCertificateAlias(String)}. If no sender is indicated in mandatory cases,
	 * a dialog will be displayed, promting the user to select it.
	 * <br/>Results may me retrieved in base64 with {@link #getB64Data()} and 
	 * can be saved to a file with {@link #saveDataToFile()}.
	 * 
	 * @return Devuelve <code>true</code> si la operaci&oacute;n finaliz&oacute; con &eacute;xito.
	 * <br> Returns <code>true</code> if operation ended successfully.
	 */
	 ...
	 * </ul>
	 * <br><br>
	 * Sets a type of contents for the generation of a CMS structure. 
	 ...
	 * <li><b>SignedAndEnvelopedData:</b> Enveloped and Signed Data Structure  (Signed digital 
	 * envelope).</li>
	 * <li><b>AuthEnvelopedData:</b> Authenticated and enveloped data structure (Authenticated digital
	 * envelope)</li>
	 * </ul>
	 * 
	 ...
	 * <br><br>
	 * 
	 * Returns data generated during the last base 64-encrypted enveloping operation. If no such operation 
	 * has been executed, an empty string is returned.
	 * 
	 * @return String en Base 64.
	 * <br> String in base 64.
	 ...
	 * <br><br>
	 * 
	 * Recovers a digital envelope's contents. Envelope will be indicated with a base 64 string
	 * with <code>setData</code> or w<code>setFileuri</code>.
	 * <br/>In the case of <code>EncryptedData</code> envelopes, it may be indicated whether password or key 
	 * was used for encryption with {@link #setKeyMode(String)} method. In turn, these may be set with
	 *  {@link #setPassword(String)} or {@link #setKey(String)}, respectively.
	 * <br/>In case of  <code>EnvelopedData</code> and  <code>SignedAndEnvelopedData</code> envelopes
	 * certificate for decryption may be set with 
	 * {@link #setSelectedCertificateAlias(String)}.
	 * <br/>Results can be retrieved in base 64 with {@link #getB64Data()} and  
	 * can be saved to a file with {@link #saveDataToFile()}.
	 * 
	 * 
	 ...
	 * <br>DER object in base 64.
	 * @return Cadena correspondiente al objeto CMS.
	 * <br> String for the CMS object.
	 */
	 ...
	 * o {@link #setFileuri(String)}
	 * El resultado puede ser recuperado mediante {@link #getB64Data()}
	 * 
	 * <br><br>
	 * 
	 * Signs and packs in a digital envelope the digital data specified by {@link #setData(String)}. 
	 * Results can be retrieved with {@link #getB64Data()} or {@link #setFileuri(String)}.
	 * 
	 * @return true si la operaci&oacute;n se ha efectuado correctamente
	 * <br> true if successful.
	 */
	 ...
	 * <br><br>
	 * 
	 * Signs and packs in a digital envelope the file specified by uri.
	 * Results can be retrieved with {@link #getB64Data()}.
	 * 
	 * @param uri Localizaci&oacute;n en formato URI de los datos a firmar y empaquetar
	 * <br>Location in URI format of data to sign and pack.
	 * @return true si la operaci&oacute;n se ha efectuado correctamente
	 * <br>true if successful.
	 */
	...
	/**
	 * Agrega un nuevo remitente a un sobre electr&oacute;nico especificado mediante
	 * {@link #setData(String)} o {@link #setFileuri(String)}.
	 * El resultado puede ser recuperado mediante {@link #getB64Data()}.
	 * 
	 * <br><br>
	 * 
	 * Add a new sender in a digital envelope specified with {@link #setData(String)}
	 * or {@link #setFileuri(String)}.
	 * Results can be retrieved with {@link #getB64Data()}.
	 * 
	 * @return true si la operaci&oacute;n se ha efectuado correctamente.
	 ...
	 * 
	 * <br><br>
	 * Sets the necessary configuration for the client to connect with an LDAP server.
	 * If no port is indicated, or a wrong parameter is given, LDAP default port will be used.
	 * LDAP address is mandatory.
	 * 
	 * @param address Direcci&oacute;n URL del LDAP (Actualmente, sin uso).
	 * <br> LDAP URL address (currently not in use)
	 * @param port Puerto a trav&eacute;s del que se realiza la conexi&oacute;n.
	 * <br>Connection port.
	 * @param root Direcci&oacute;n ra&iacute;z del LDAP.
	 * <br> LDAP root address.
	 */
	 ...
	 * 
	 * <br><br>
	 * Retrieves a base 64 certificate from an LDAP server. 
	 * It is necessary to previously establish LDAP configuration
	 * and the conditions to identify this certificate.
	 * 
	 * 
	 * @return Certificado descargado en base 64.
	 * <br>Downloaded certificate in base 64.
	...
	//************ ORIGINAL MASSIVE SIGNATURE FUNCTIONALITIES ***********/	
	//*******************************************************************/
	 ...
	 * <br><br>
	 * 
	 * Adds a base 64 hash for massive signature.
	 * 
	 * @param aHash Hash que se desea firmar.
	 * <br>Hash desired for signature.
	 */
	 ...
	 * resultado se almacenar&aacute; en el directorio de entrada. Si se indica el
	 ...
	 * Signature will always be performed in an explicit way, except in cases where the specific
	 * signature format requires otherwise. Signature directory can be set with 
	 * {@link #setInputDirectoryToSign(String)}. Else, a dialog will be displayed, prompting the selection of
	 * a directory. {@link #setInRecursiveDirectorySign(boolean)} must be used to indicate that subdirectory files 
	 * are also meant for signing. A limit may be established on the files to be signed with a filter set  with {@link #setInIncludeExtensions(String)}.
	 * <br/>Massive operation to perform will by default be signature, although 
	 * this can be modified in order to perform cosignature or counter-signature (whole signature tree or
	 * just the leave nodes). The kind of operation is indicated with 
	 * {@link #setMassiveOperation(String)}. 
	 * <br/>If no output directory is indicated with {@link #setOutputDirectoryToSign(String)} results 
	 * will be saved in the input directory. If indicated output directory does not exist
	 * it will be created. 
	 * </br>If an error occurs during the signature of a file, the process will continue,
	 * an entry will be created in the error log in the signature output directory, 
	 * and <code>false</code> will be returned, for the adequate operations to be performed. 


	 * @return Devuelve <code>true</code> si la firma ha sido correcta para todos los ficheros afectados.
	 * <br>Returns <code>true</code> if the signature was correct for all appropriate files.
	 */
	public boolean signDirectory();

	/**
	 * Establece la operaci&oacute;n masiva a realizar en el proceso generado por los m&eacute;todos
	 * {@link #signDirectory()}, {@link #massiveSignatureData(String)} y
	 * {@link EntryPointsCrypto#massiveSignatureFile(String)}.  
	 * <br/>Los tipos de operaci&oacute;n permitidos son:
	 * <ul>
	 ...
	 * <br><br>
	 * 
	 * Sets the massive operation to be performed in the process generated by the {@link #signDirectory()},
	 * {@link #massiveSignatureData(String)} and {@link EntryPointsCrypto#massiveSignatureFile(String)}
	 * methods.
	 * <br/>The massive operations are:
	 * <ul>
	 * <li>FIRMAR: Sign.</li>
	 ...
	 * <br> Type of massive operation to perform.
	 */
	 ...
	 * <br><br>
	 * 
	 * Sets whether the original signature format for massive multi-signature operations or
	 * the signature configuration used for all signatures should be used. By default, original format is used.
	 * 
	 * @param originalFormat Indica si respetar el formato original.
	 * <br>Sets whether or not to use the original format.
	 */
	 ...
	 * <br><br>
	 * 
	 * Returns the absolute route of the directory where files to be massively signed are found.
	 * 
	 * @return Ruta absoluta del directorio.
	 * <br> Absolute route of the directory.
	 */
	 ...
	 * <br><br>
	 * 
	 * Selects the directory from where signature files and data for the massive signature operation will be taken from.
	 * 
	 * 
	 ...
	 * <br><br>
	 * 
	 * Returns the absolute route of the directory where signatures resulting from the massive signature operation 
	 * will be stored.
	 * 
	 * @return Ruta absoluta del directorio de salida de la firma masiva.
	 * <br> Absolute route of the massive signature output directory.
	 */
	 ...
	 * situados en <code>InputDirectoryToSign</code>.
	 * <br><br>
	 * 
	 * Sets the output directory where massive signatures of files located in <code>InputDirectoryToSign</code>
	 * will be saved.
	 * 
	 * @param directory Ruta absoluta del directorio.
	 * <br>Absolute route of the directory.
	 ...
	 * <br><br>
	 * 
	 * Sets extensions to be included in the signature of directories.
	 * String to enter matches the extensions, 
	 * separated by ','. To eliminate extension filtering, 
	 * <code>null</code> must be entered.
	 * Example: <code>TXT,JPG,BMP,DAT</code>
	 * 
	 * 
	 * @param extensions Extensiones de los ficheros que se desean firmar.
	 * <br>File extensions for the files to be signed.
	 */
	 ...
	 * <br><code>true</code> to sign a directory and its subdirectories. <code>false</code> otherwise.
	 */
	 ...
	 * <br><br>
	 * 
	 * Takes the client's massive signature configuration and prepares the massive signature 
	 * process. Data taken from the client's configuration: 
	 * <ul>
	 ...
	 * </ul>
	 * In case of a signature certificate, it will be prompted for when unspecified.<br/>
	 * This method also restarts the massive signature's procedure log.
	 * Once the massive signature procedure has been prepared, any changes in 
	 * client's configuration (except for the operation to be executed) will not affect it.
	 * Thus, for example, a different signature certificate could be specified, but all 
	 * operations within the massive signature procedure will use the previously defined 
	 * certificate, or the one set in the initialization process.<br/>
	 * Once the massive signature process is ended, it is advisable to use 
	 * {@link #endMassiveSignature()} to eliminate the procedure's configuration.

	 * 
	 * @return Devuelve <code>true</code> si la operaci&oacute;n masiva se inicializ&oacute; correctamente,
	 * <code>false</code> en caso contrario.
	 * <br> Returns <code>true</code> if the massive operation is properly initialized. Else, 
	 * <code>false</code>.
	 * @see #setSignatureAlgorithm(String)
	 * @see #setSignatureFormat(String)
	 ...
	 * <br><br>
	 * 
	 * Frees the massive signature procedure configuration which was previously initialized.
	 */
	public void endMassiveSignature();

	/**
	 * Firma datos con la configuraci&oacute;n de firma masiva establecida.
	 * En el caso de la operaci&oacute;n de firma masiva tendremos que indicar los
	 * datos que deseamos firmar, mientras que para las operaciones de
	 * cofirma y contrafirma se indicar&aacute; la firma con la que se operar&aacute;. 
	 * 
	 * <br><br>
	 * 
	 * Signs data with the set massive signature configuration. 
	 * In case of a massive signature operation data to be signed must be 
	 * indicated. In turn, for massive co-sign and counter-signature operations,
	 * must be set the signature to co-sign or counter-sign.
	 * 
	 * @param b64Data Datos en base 64 a firmar.
	 * <br>Data in base 64 to be signed.
	 * @return Firma resultado en base 64 o <code>null</code> en caso de error. 
	 * <br>Resulting signature in base 64 or <code>null</code> if error occurs. 
	 */
	 ...
	 * <br><br>
	 * 
	 * Signs a hash with the set massive signature configuration. 
	 * This method is valid only for the massive signature operation (i.e., not for cosignature or counter-signature).
	 * 
	 * @param b64Hash Hash en base 64 a firmar.
	 * <br>Hash in base 64 to be signed.
	 * @return Firma resultado en base 64 o <code>null</code> en caso de error.
	 * <br>Resulting signature in base 64, or <code>null</code> if error occurs.
	 */
	 ...
	 * <br><br>
	 * 
	 * Signs a file with the set massive signature configuration. 
	 * In case of a massive signature operation the file with the data to be signed must 
	 * be indicated. In turn, for massive co-sign and counter-signature operations,
	 * must be set the signature file to co-sign or counter-sign.
	 * 
	 * @param fileuri Ruta del fichero a firmar.
	 * <br>Route to the file to be signed.
	 * @return Firma resultado en base 64 o <code>null</code> en caso de error. 
	 * <br>Resulting signature in base 64. <code>null</code>, if error occurs.
	 */
	 ...
	 * <br><br>
	 * 
	 * Stores in a file every log trace generated by the massive signature procedure. File's route can be set
	 * with {@link #setOutFilePath(String)}. Else, a window will be displayed, 
	 * prompting the user where to store the log file.
	 * 
	 */
	 ...
	 * </ul>
	 * Se recomienda utilizar {@code initialize()} antes de usar este m&eacute;todo. 
	 * 
	 * <br><br>
	 * 
	 * Sets the active repository. This will be accessed for certificate retrieval, in signature and 
	 ...
	 * <br> Repository route (or its driver, if applicable)
	 * @param password Contrase&ntilde;a para el acceso al repositorio si procede.
	 * <br>Access password to the repository, if applicable.
	 ...
	 * <br><br>
	 * 
	 * Sets the policy for signatures. Used for the generation of EPES advanced signatures.
	 * 
	 ...
	 *                   <br>URL identifying the signature policy (normally, a URL pointing to the 
	 *                   document describing this policy)
	 * @param description Descripci&oacute;n de la pol&iacute;tica.
	 * <br> Policy description.
	 * @param qualifier Oid cualificador de la pol&iacute;tica de firma.
	 * <br>Signature policy's qualifying oid.
	 */
	 ...
	 * 
	 * 
	 * Gets all certificate aliases available for signing or encrypting, and returns them 
	 * as a single string with aliases separated by {@link es.gob.afirma.cliente.SignApplet#STRING_SEPARATOR}
	 * 
	 * @return Todos los alias de los certificados disponibles.
	 * <br> All available certificate's aliases.
	 */
	 ...
	 * <br><br>
	 * 
	 * Gets all signature or encryption available certificates' aliases 
	 * and returns them in an array.
	 * 
	 * @return Alias de los certificados disponibles.
	 * <br> Available certificates' aliases.
	 */
	 ...
	 * <br> String with all certificates.
	 */
	 ...
	 * <br>Certificate alias meant for retrieval.
	 * @return Certificado recuperado o <code>null</code> en caso de error.
	 * <br> Retrieved certificate or <code>null</code> if error occurs.
	 */
	 ...
	 *  <br><br>
	 *  
	 * Retrieves a certificate's public key from the current repository, under the form:
	 * <p><code>
	 * -----BEGIN RSA PUBLIC KEY-----<br/>
	 ...
	 *  <br>Alias of certificate to recover public key from.
	 *  @return Clave p&uacute;blica del certificado o <code>null</code> en caso de error.
	 *   <br>Certificate's public key or <code>null</code> if error occurs.
	 */
	 ...
	 * 
	 * @param certAlias Alias del certificado. Debe coincidir con un alias de un certificado presente
	 *                  en el <code>KeyStore</code> activo
	 *                  <br>Certificate's alias. Must match an alias of a certificate found in the active <code>KeyStore</code>.
	 */
	 ...
	 * <br><br>
	 * 
	 * Sets a filter for the selection of certificates. Only those complying with selection criteria 
	 * will be displayed in the selection dialog.
	 * <b>N.B.:</b> Filter is not applied in the direct retrieval of keystore aliases  
	 * (getCertificatesAlias, getCertificates, etc.).

	 * 
	 * 
	 * @param subjectFilter Filtro para el titular del certificado, seg&uacute;n formato definido en la normativa RFC 2554
	 * <br>Certificate's holder filter, in accordance to format defined in RFC 2554.
	 * @param issuerFilter Filtro para el emisor del certificado, seg&uacute;n formato definido en la normativa RFC 2554
	 * <br> Certificate's issuer filter, as defined in RFC 2554.
	 ...
	 *                                  <br>If set to  <code>true</code>, only certificates with an activated <i>nonRepudiation</i> bit in 
	 *                                  field <i>KeyUsage</i> bit are displayed for selection. If set to <code>false</code> all 
	 ...
	 * <br><br>
	 * 
	 * Sets a condition to select a certificate with which to sign. Users are not allowed to choose the certificate
	 * as they are deemed "forced" to sign with a specific one. In case of more than one certificate 
	 * satisfying the condition, it is assumed that the user has more than one of that kind and is thus allowed to 
	 * choose. If no certificate installed in the browser satisfies the condition, an error will be displayed.
	 * 
	 * 
	 * @param subjectFilter Filtro para el titular del certificado, seg&uacute;n formato definido en la normativa RFC 2554
	 ...
	 * <br><br>
	 * 
	 * Shows the selected keystore certificate selection dialog, applying filters, if necessary. 
	 * Returns null if a problem occurs during the selection, or dialog is cancelled.<br/>
	 * Selected certificate is set as last used certificate, i.e., it may be recovered with {@link #getSignCertificate()} and  
	 * {@link #getSignCertificateBase64Encoded()}. 
	 * 
	 *  
	 * @return Alias real (con el que fue dado de alta en el almac&eacute;n de claves) del certificado
	 * seleccionado.
	 * <br> Selected certificate's real alias (alias used for registering in the keystore)
	 */
	 ...
	 * <br><br>
	 * 
	 * Returns unencrypted data generated in the last operation. If no such operation was executed, an empty
	 * string is returned. 
	 * 
	 * @return String de los datos de salida
	 * <br>Output data string.
	 ...
	 * <br>This operation is discouraged, since results may vary depending on system's coding.
	 */
	@Deprecated
	 ...
	 * <br><br>
	 * 
	 * After a massive signature (signature from multiple hashes), it returns signatures in base 64 separated
	 * by '!' (exclamation mark). If no signatures are set <br/>
	 * <b>N.B.: </b> Once the signature has been recovered, it is advisable to free
	 * applet resources with <code>initialize</code>.
	 * 
	 * @return Las firmas en base64 separadas unas de otras por el signo de cierre de admiraci&oacute;n (!)
	 * <br> Signatures in base 64, separated by an exclamation mark.
	 * @deprecated Por el consumo excesivo de memoria. 
	 * <br> By excessive memory consumption.
	 */
	@Deprecated
