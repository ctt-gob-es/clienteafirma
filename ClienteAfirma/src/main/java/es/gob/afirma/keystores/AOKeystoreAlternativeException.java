...
/**
 * Indica que ocurri&oacute; un error intentando obtener un
 * <code>KeyStore</code>, pero que se obtuvo uno de un tipo alternativo.
 * 
 * @version 0.1
 */
public final class AOKeystoreAlternativeException extends Exception {
	...
	public AOKeystoreAlternativeException(final AOConstants.AOKeyStore ks,
			final String desc, final Exception e) {
		super(desc, e);
		if (ks == null)
