...
public final class AOConstants {
	...
	public enum AOCipherAlgorithm {
		...
		AES("AES", "Advanced Encryption Standard (AES)", false, true,
		...
		DES("DES", "Data Encryption Standard (DES)", false, true,
				"1.2.840.113549.3.6"),
		/** Triple DES (3DES). */
		TRIPLEDES("DESede", "Triple DES (3DES)", false, true,
				"1.2.840.113549.3.7"),
		/** RC2. */
		RC2("RC2", "RC2", false, true, "1.2.840.113549.3.3"),
		/** Contrase&ntilde;a con MD5 y DES. */
		PBEWITHMD5ANDDES("PBEWithMD5AndDES", "Contrase\u00F1a con MD5 y DES",
				true, false, "1.2.840.113549.1.5.3"),
		/** Contrase&ntilde;a con SHA1 y 3DES. */
		PBEWITHSHA1ANDDESEDE("PBEWithSHA1AndDESede",
				"Contrase\u00F1a con SHA1 y 3DES", true, false,
				"1.2.840.113549.1.5.10"),
		/** Contrase&ntilde;a con SHA1 y RC2. */
		PBEWITHSHA1ANDRC2_40("PBEWithSHA1AndRC2_40",
				"Contrase\u00F1a con SHA1 y RC2", true, false,
		...
		/** MAC HMACSHA256 **/
		HMACSHA256("HmacSHA256", "HmacSHA256", false, true,
				"1.2.840.113549.2.9"),
		/** MAC HMACSHA384 **/
		HMACSHA384("HmacSHA384", "HmacSHA384", false, true,
				"1.2.840.113549.2.10"),
		/** MAC HMACSHA512 **/
		HMACSHA512("HmacSHA512", "HmacSHA512", false, true,
				"1.2.840.113549.2.11");
		...
		private AOCipherAlgorithm(String n, String d, boolean p, boolean k,
				String oi) {
			name = n;
			description = d;
			password = p;
		 ...
		 * algoritmo indicado es nulo o no esta soportado, se devolver&aacute;
		 * <code>null</code>.
		 * 
		 * @param algorithmName
	...
	public enum AOCipherPadding {
		 ...
		 * indicado es nulo o no est&aacute; soportado, se devolver&aacute;
		 * <code>null</code>.
		 * 
		 * @param paddingName
	...
	public static final String DEFAULT_CIPHER_CONFIG = AOCipherAlgorithm.AES
			.name()
			+ "/"
	...
	public static final String[] SUPPORTED_SIGN_ALGOS = new String[] {
			SIGN_ALGORITHM_SHA1WITHRSA, SIGN_ALGORITHM_MD5WITHRSA,
			SIGN_ALGORITHM_MD2WITHRSA, SIGN_ALGORITHM_NONEWITHRSA,
			SIGN_ALGORITHM_SHA256WITHRSA, SIGN_ALGORITHM_SHA384WITHRSA,
			SIGN_ALGORITHM_SHA512WITHRSA, SIGN_ALGORITHM_SHA1WITHECDSA,
	...
	public static final Map<String, String> SIGN_ALGOS_URI = new HashMap<String, String>() {
		...
		{
			put(SIGN_ALGORITHM_SHA1WITHRSA,
			...
			put("SHA1withRSAEncryption",
					"http://www.w3.org/2000/09/xmldsig#rsa-sha1");
			put("SHA-1withRSAEncryption",
					"http://www.w3.org/2000/09/xmldsig#rsa-sha1");
			put("SHAwithRSAEncryption",
					"http://www.w3.org/2000/09/xmldsig#rsa-sha1");
			put("SHAwithRSA", "http://www.w3.org/2000/09/xmldsig#rsa-sha1");

			put(SIGN_ALGORITHM_MD5WITHRSA,
					"http://www.w3.org/2001/04/xmldsig-more#rsa-md5");

			put(SIGN_ALGORITHM_SHA256WITHRSA,
			...
			put("SHA256withRSAEncryption",
					"http://www.w3.org/2001/04/xmldsig-more#rsa-sha256");
			put("SHA-256withRSAEncryption",
					"http://www.w3.org/2001/04/xmldsig-more#rsa-sha256");

			put(SIGN_ALGORITHM_SHA384WITHRSA,
			...
			put("SHA384withRSAEncryption",
					"http://www.w3.org/2001/04/xmldsig-more#rsa-sha384");
			put("SHA-384withRSAEncryption",
					"http://www.w3.org/2001/04/xmldsig-more#rsa-sha384");

			put(SIGN_ALGORITHM_SHA512WITHRSA,
	 ...
	 * digitales.
	 */
	public static final Boolean[] SIGN_CERT_USAGE = { null, // digitalSignature
			true, // nonRepudiation
