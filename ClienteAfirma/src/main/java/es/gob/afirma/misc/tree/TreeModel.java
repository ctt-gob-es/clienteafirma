...
/** Adaptaci&oacute;n de las clases TreeModel de Swing para su uso sin interfaz gr6aacute;fico. */
public final class TreeModel {
    ...
    private TreeModel(final TreeNode root, final boolean asksAllowsChildren) {
        super();
        this.root = root;
    ...
    public TreeModel(final TreeNode treeRoot, final int count) {
        this(treeRoot, false);
        this.count = count;
    }
