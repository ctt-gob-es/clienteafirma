...
public final class FileUtils {
	 ...
	 *            Ruta del fichero.
	 * @param waitDialog
	 *            Mostrar di&aacute;logo de espera.
	 * @param parent
	 *            Componente padre sobre el que mostrar el di&aacute;logo de
	 *            carga.
	 * @return Contenido del fichero.
	 */
	public static byte[] loadFile(final String path, final boolean waitDialog,
		...
		if (loadFileAction.isError()) {
			Logger.getLogger("es.gob.afirma").severe(
					loadFileAction.getErrorMessage());
			return null;
		}
	 ...
	 * @return Contenido del fichero.
	 */
	public static byte[] loadFile(final URI uri, final boolean waitDialog,
			final Component parent) {
