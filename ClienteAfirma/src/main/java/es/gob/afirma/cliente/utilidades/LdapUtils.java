...
public final class LdapUtils {
    ...
    public static X509Certificate getCertificate(final String server, final int port, final String principal) throws Exception {
        if (server == null || "".equals(server)) throw new NullPointerException("El servidor no puede ser nulo ni vacio");
        if (principal == null || "".equals(principal)) throw new NullPointerException("El Principal del Certificado no puede ser nulo ni vacio");
