 ...
 */
public abstract class BasicPrivilegedAction<T, U> implements
		PrivilegedAction<T> {
	 ...
	 * error o si la operaci&oacute;n no produjo ning&uacute;n error, devuelve
	 * {@code null}.
	 * 
	 ...
	 * 
	 * @return <code>true</code> si ocurri&oacute; alg&uacute;n error,
