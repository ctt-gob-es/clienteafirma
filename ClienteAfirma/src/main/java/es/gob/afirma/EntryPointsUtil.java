 ...
 * utilidad del Cliente AFirma para su uso como Applet Java.
 * 
 * <br>
 * <br>
...
public interface EntryPointsUtil {
	 ...
	 * operaci&oacute;n se devolver&aacute; <code>null</code>.
	 * 
	 * <br>
	 * <br>
	 ...
	 * alg&uacute;n error durante la operaci&oacute;n se devolver&aacute;
	 * <code>null</code>. <br>
	 * <br>
	 ...
	 *            errores mediante un di&aacute;logo gr&aacute;fico,
	 ...
	 * debe tener uno o m&aacute;s d&iacute;gitos; y
	 ...
	 * version, sub-version, and build and must contain one or more digits.
	 * <code>Descripci&oacute;n</code> is an optional free text used to
	 ...
	 * @param exts
	 *            Extensiones de b&uacute;squeda (separadas por
	 *            {@link es.gob.afirma.cliente.SignApplet#STRING_SEPARATOR
	 *            STRING_SEPARATOR}) <br>
	 *            Search extensions (separated by
	 *            {@link es.gob.afirma.cliente.SignApplet#STRING_SEPARATOR
	 *            STRING_SEPARATOR})
	 * @param description
	 ...
	 * directorio. Si no se selecciona ning&uacute;n directorio, se devuelve
	 * <code>null</code>. <br>
	 * <br>
