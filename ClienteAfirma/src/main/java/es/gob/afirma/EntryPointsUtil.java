...
public interface EntryPointsUtil {
     ...
     * 		<br>File contents, codified in base 64.
     * @see #getFileBase64Encoded(String, boolean)
     */
    public String getFileBase64Encoded(boolean showProgress);
    
    /**
     * Devuelve el contenido de un fichero en base 64. Si se produce alg&uacute;n
     * error durante la operaci&oacute;n se devolver&aacute; <code>null</code>.
     *  <br><br>
     *  Returns the contents of a file in base 64. If fileUri parameter has been previously set (with setFileUri), modifications are kept. If errors ocurr during operation <code>null</code> is returned.  
     *  @param fileUri 
     *            URL al fichero de entrada
     *            <br>URL to input file
     * @param showProgress
     ...
     * <br><br>
     * Returns a file's hash (as previously specified with setFileURI), codified in base 64.
     * Hash is calculated with the client's default hash algorithm. If an error occurs 
     * during the operation, <code>null</code> is returned.
     * 
     * @param showProgress
     *            Mostrar o no ventana de progreso de la lectura del fichero
     *            <br> Show / Hide File Read Progress window
     * @return El hash del fichero, en base 64.
     *         <br>
     ...
     * 
     * @param url URL del fichero a leer.
     * <br>
     ...
     * <br> true if last execution could not be correctly completed. Otherwise, false.
     */
     ...
     * <br><br> Returns error message, if applet is in error state.
     * If not in error state, returns empty string.
     ...
     * Debe evitarse el uso de esta funci&oacute;n.  En su lugar, es preferible mostrar los mensajes 
     * mediante JavaScript, por defecto no se mostrar&aacute;n 
     * <br><br>
     * Sets  whether errors should be displayed graphically as they occur.
     * Use of this function should be avoided in favor of  Java Script. By default, errors are not displayed. 
     ...
     *<br><code>true</code> if errors must be displayed using a graphical dialog. Else, <code>false</code>.
     *
     */
	public void setShowErrors(boolean showErrors);
    
    /**
     * Si showHashMessage=true, se muestra el mensaje informativo sobre el hash de los
     * datos a firmar. Si showHashMessage=false, no se muestra el mensaje.
     * <br><br>
     * If showHashMessage=true, a message is displayed, regarding the hash of data to be signed. 
     * If showHashMessage=false, it isn't show the message.
     * @param showHashMessage Indica si se debe mostrar el nmensaje.
     * <br> Indicates whether void or not yet the message should be displayed.
     * @deprecated El applet no debe mostrar nunca al usuario el hash de los datos a firmar.
     * <br> Applet must never display the hash of data to be signed. 
     */
    @Deprecated
     ...
     * <br><br>
     * Indicates whether void or not yet active certificates should be displayed in the list of certificates 
     * available to be signed.
     * @param showExpiratedCerts Indica si se deben mostrar los certificados expirados o aun no
     * v&aacute;lidos.
     * <br> Indicates whether void or not yet valid certificates should be displayed. 
     */
     ...
     * <br> Returns <code>true</code> if applet has been initialized.
     * @return <code>true</code> si el Applet ha sido inicializado
     * <br> <code>true</code> if applet has been initialized.
     */
     ...
     *<br><br>
     * Restarts all signature client parameters (input parameters are set to their default value, and output parameters
     * are set to null) and error state is removed. This method is desirable for complex operations (e.g., signature, multi-signature, 
     * cyphering, digital enveloping) and later data storage.  
     */
     ...
     * <br><br>
     * Decodes a text in base 64. If an error occurs, <code>null</code> is returned. 
     ...
     * <br><br>
     * Encodes plain text to base 64. If an error occurs, <code>null</code> is returned.
     ...
     * y construcci&oacute;n del cliente y debe tener uno o m&aacute;s d&iacute;gitos; y 
     ...
     * <code>X.Y.Z Descripci&oacute;n</code><br/>
     * Where <code>X</code>, <code>Y</code> and  <code>Z</code> are the client's version, sub-version, and build
     * and must contain one or more digits.
     * <code>Descripci&oacute;n</code> is an optional free text used to supplement client's version identification. 
     * 
     ...
     * <br><br>
     * Displays a modal dialog for the selection of a file, from which the whole route will be returned. 
     * If no file is selected, <code>null</code> is returned.
     * @param title T&iacute;tulo del di&aacute;logo modal.
     * <br> Modal dialog's title.
     ...
     * <br> Search extensions (separated by {@link es.gob.afirma.cliente.SignApplet#STRING_SEPARATOR STRING_SEPARATOR})
     * @param description Descripcion del tipo de ficheros buscado.
     * <br> Description of the search files' type.
     * @return Ruta completa del fichero seleccionado.
     * <br> Complete route to the selected file.
     */
    public String loadFilePath(String title, String exts, String description);
    
    /**
     * Muestra un di&aacute;logo modal para la selecci&oacute;n de un directorio. Si no
     * se selecciona ning&uacute;n directorio,
     * se devuelve <code>null</code>.
     * <br><br>
     * Displays a modal dialog for the selection of a directory. 
     * If no directory is selected, <code>null</code> is returned.
     *  
     * @return Ruta completa del directorio seleccionado.
     * <br> Complete route for the selected directory.
     */
    public String selectDirectory();
    
    /**
	 * Cambia el idioma del actual del Cliente.
	 * 
	 * <br><br>
	 *  
	 * Change the current language.
	 *  
	 * @param locale C&oacute;digo de idioma (por ejemplo: en, es, it...).
	 * 				 <br>Language code (p.e. en, es, it...)
	 */
...
//	 * @return Devuelve {@code true} si quedan datos por recuperar, {@code false} en caso contrario.
//	 */
