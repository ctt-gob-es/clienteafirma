...
public final class CAdESPreCounterSignResult {
	...
	public void addSign(final byte[] data, final byte[] randomDummyData) {
	...
	public void addSignTemplate(final byte[] pcs) {
		if (pcs == null) {
