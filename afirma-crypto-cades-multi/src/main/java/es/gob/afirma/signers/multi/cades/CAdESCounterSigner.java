 ...
 * crear un mensaje SignedData de bouncycastle pero con la
...
final class CAdESCounterSigner {
    ...
    byte[] counterSign(final String algorithm,
        ...
        final SignedData signedData = SignedData.getInstance(pkcs7RootContextSpecificZero.getExplicitBaseObject());
