...
/** Di&aacute;logo para mostrar certificados con est&eacute;tica similar al de Windows 7.
 * @author Jos&eacute; Montero Rivero */
public final class ShowCertificatesDialog extends MouseAdapter {

	private static final Logger LOGGER = Logger.getLogger("es.gob.afirma"); //$NON-NLS-1$
	private final ShowCertificatesPanel csd;
	private final JOptionPane optionPane;
	private final Component parent;
	private final KeyStoreDialogManager ksdm;
	private final String currentKeyStoreTypeName;

	private final boolean disableSelection;

	/** Construye el di&aacute;logo para mostrar certificados a partir del listado con
	...
	public ShowCertificatesDialog(final Component parent,
	...
	public ShowCertificatesDialog(final Component parent,
	    ...
	    this.csd = new ShowCertificatesPanel(
    		certs,
    		this,
    		dialogHeadline,
    		dialogSubHeadline,
	...
	public String showDialog() throws  CertificatesNotFoundException {
		...
		this.certDialog = this.optionPane.createDialog(
			...
			CertificateSelectionDialogMessages.getString(
					"CertificateSelectionDialog.0", this.currentKeyStoreTypeName + ":" + this.ksdm.getLibName()) //$NON-NLS-1$
		);
		...
		final KeyEventDispatcher dispatcher = new ShowCertificatesDispatcherListener(
			this.optionPane,
			this
		);
	...
	private static final class CertOptionPane extends JOptionPane {
		...
		private final ShowCertificatesPanel selectionPanel;

		CertOptionPane(final ShowCertificatesPanel csd) {
