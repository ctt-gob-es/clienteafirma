...
/** Panel para mostrar certificados con est&eacute;tica Windows 7. */
final class ShowCertificatesPanel extends JPanel implements ListSelectionListener {
	...
	ShowCertificatesPanel(final NameCertificateBean[] el,
			                  final ShowCertificatesDialog showCertificatesDialog,
	...
	private void createUI(final ShowCertificatesDialog showCertsDialog,
			              final String dialogHeadline,
			              final boolean showControlButons) {
        ...
        if (highContrastProp instanceof Boolean) {
        	ShowCertificatesPanel.highContrast = ((Boolean) highContrastProp).booleanValue();
        }

        if (!ShowCertificatesPanel.highContrast) {
        	try {
		...
		if (showControlButons) {
			...
			if (!ShowCertificatesPanel.highContrast) {
				refreshImgResource = ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_autorenew_black_18dp.png"); //$NON-NLS-1$
			} else {
				refreshImgResource = ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_autorenew_white_18dp.png"); //$NON-NLS-1$
			}
			...
			refresh.addActionListener(
				new ActionListener() {
					...
					public void actionPerformed(final ActionEvent e) {
						UtilActions.doRefresh(showCertsDialog, ShowCertificatesPanel.this);
					}
				}
			);
			refresh.addFocusListener(
					new FocusListener() {
						  ...
						  public void focusGained(final FocusEvent e) {
							  if (isHighContrast()) {
								 refresh.setIcon(new ImageIcon(
										 ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_autorenew_black_18dp.png"), //$NON-NLS-1$
										 CertificateSelectionDialogMessages.getString("UtilToolBar.1") //$NON-NLS-1$
								));
							 }
						  }
						  ...
						  public void focusLost(final FocusEvent e) {
							  if (isHighContrast()) {
								 refresh.setIcon(new ImageIcon(
										 ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_autorenew_white_18dp.png"), //$NON-NLS-1$
										 CertificateSelectionDialogMessages.getString("UtilToolBar.1") //$NON-NLS-1$
								));
							 }
						  }
			...
			menuItemPersonalView.addActionListener(new ChangeViewActionListener(this, showCertsDialog, CertificateLineView.PERSONAL));
			...
			menuItemRepresentativeView.addActionListener(new ChangeViewActionListener(this, showCertsDialog, CertificateLineView.REPRESENTATIVE));
			...
			menuItemPseudonymView.addActionListener(new ChangeViewActionListener(this, showCertsDialog, CertificateLineView.PSEUDONYM));
			...
			if (!ShowCertificatesPanel.highContrast) {
				viewArrowImgResource = ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_view_arrow_black.png"); //$NON-NLS-1$
			} else {
				viewArrowImgResource = ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_view_arrow_white.png"); //$NON-NLS-1$
			}
			...
			dropDownButton.addFocusListener(
					new FocusListener() {
						  ...
						  public void focusGained(final FocusEvent e) {
							  if (isHighContrast()) {
								  dropDownButton.setIcon(new ImageIcon(
										 ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_view_arrow_black.png"), //$NON-NLS-1$
										 CertificateSelectionDialogMessages.getString("UtilToolBar.1") //$NON-NLS-1$
								));
							 }
						  }
						  ...
						  public void focusLost(final FocusEvent e) {
							  if (isHighContrast()) {
								  dropDownButton.setIcon(new ImageIcon(
										 ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_view_arrow_white.png"), //$NON-NLS-1$
										 CertificateSelectionDialogMessages.getString("UtilToolBar.1") //$NON-NLS-1$
								));
							 }
						  }
			...
			if (!ShowCertificatesPanel.highContrast) {
				helpImgResource = ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_help_black_18dp.png"); //$NON-NLS-1$
			} else {
				helpImgResource = ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_help_white_18dp.png"); //$NON-NLS-1$
			}
			...
			help.addFocusListener(
					new FocusListener() {
						  ...
						  public void focusGained(final FocusEvent e) {
							  if (isHighContrast()) {
								 help.setIcon(new ImageIcon(
										 ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_help_black_18dp.png"), //$NON-NLS-1$
										 CertificateSelectionDialogMessages.getString("UtilToolBar.1") //$NON-NLS-1$
								));
							 }
						  }
						  ...
						  public void focusLost(final FocusEvent e) {
							  if (isHighContrast()) {
								 help.setIcon(new ImageIcon(
										 ShowCertificatesPanel.class.getResource("/resources/toolbar/ic_help_white_18dp.png"), //$NON-NLS-1$
										 CertificateSelectionDialogMessages.getString("UtilToolBar.1") //$NON-NLS-1$
								));
							 }
						  }
		...
		this.certList.setCellRenderer(new CertListCellRendered(windowColor, ShowCertificatesPanel.highContrast));
	...
	private static CertificateLineView loadPreferredCertificateView() {
		...
		try {
			final Preferences pref = Preferences.userNodeForPackage(ShowCertificatesPanel.class);
	...
	private class ChangeViewActionListener implements ActionListener {
		...
		private final ShowCertificatesPanel panel;
		private final ShowCertificatesDialog dialog;
		private final CertificateLineView view;

		public ChangeViewActionListener(final ShowCertificatesPanel panel, final ShowCertificatesDialog dialog, final CertificateLineView view) {
			this.panel = panel;
			this.dialog = dialog;
			this.view = view;
		}
