...
public class BinaryErrorCode {
	...
	public static class Internal {
		...
		public static ErrorCode UNKWNON_BINARY_SIGNING_ERROR				= new ErrorCode("211001", "Error desconocido en la generación de la firma binaria"); //$NON-NLS-1$ //$NON-NLS-2$
		public static ErrorCode INTERNAL_BINARY_SIGNING_ERROR			= new ErrorCode("211002", "Error interno en la generación de la firma binaria"); //$NON-NLS-1$ //$NON-NLS-2$
