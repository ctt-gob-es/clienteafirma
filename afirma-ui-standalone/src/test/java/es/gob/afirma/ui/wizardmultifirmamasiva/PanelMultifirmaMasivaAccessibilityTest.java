...
/**
 * Testeo de accesibilidad para la clase MultifirmaMasiva.
 * @author lmerayo
 *
 */
public class PanelMultifirmaMasivaAccessibilityTest {

	/**
	 * Log.
	 */
	static Logger logger = Logger.getLogger(PanelMultifirmaMasivaAccessibilityTest.class.getName());
	...
	public void testNotDuplicatedLabelForProperty() {
		...
		PanelMultifirmaMasiva panelMultifirmaMasiva = new PanelMultifirmaMasiva(null, false);
		...
		Component[] components = panelMultifirmaMasiva.getComponents();
	...
	/**
	 * Método que obtiene una lista de códigos de atajos a los componentes (Etiqueta, Botón, Checkbox, Radiobutton) de un panel.
	 */
	@Ignore
