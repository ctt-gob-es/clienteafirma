...
/**
 * Testeo de accesibilidad para la clase PanelDestinatarios.
 * @author lmerayo
 *
 */
public class PanelDestinatariosAccessibilityTest {

	/**
	 * Log.
	 */
	static Logger logger = Logger.getLogger(PanelDestinatariosAccessibilityTest.class.getName());
	...
	public void testNotDuplicatedLabelForProperty() {
		...
		Component[] components = panelDestinatarios.getComponents();
