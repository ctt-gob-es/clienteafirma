...
/**
 * Testeo de accesibilidad para la clase PanelMultifirma.
 * @author lmerayo
 *
 */
public class PanelMultifirmaAccessibilityTest {

	/**
	 * Log.
	 */
	static Logger logger = Logger.getLogger(PanelMultifirmaAccessibilityTest.class.getName());
	...
	public void testNotDuplicatedLabelForProperty() {
		...
		PanelMultifirma panelMultifirma = new PanelMultifirma( null);
		...
		Component[] components = panelMultifirma.getComponents();
