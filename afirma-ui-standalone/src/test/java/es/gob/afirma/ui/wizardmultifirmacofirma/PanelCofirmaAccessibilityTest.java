...
/**
 * Testeo de accesibilidad para la clase PanelCofirma.
 * @author lmerayo
 *
 */
public class PanelCofirmaAccessibilityTest {

	/**
	 * Log.
	 */
	static Logger logger = Logger.getLogger(PanelCofirmaAccessibilityTest.class.getName());
	...
	public void testNotDuplicatedLabelForProperty() {
		...
		PanelCofirma panelCofirma = new PanelCofirma( null);
		...
		Component[] components = panelCofirma.getComponents();
