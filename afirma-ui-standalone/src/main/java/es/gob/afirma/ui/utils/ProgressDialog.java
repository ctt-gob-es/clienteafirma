...
public class ProgressDialog {
    ...
    public ProgressDialog(final JDialog parent, final int maxValue, final String title) {
    ...
    public synchronized void processElement(final String elementName) {
        if (elementName == null) {
    ...
    public void show() {
        ...
        this.dialog.setBounds(this.parent.getX() + (this.parent.getWidth() - 300) / 2,
                              this.parent.getY() + (this.parent.getHeight() - 100) / 2,
                              300,
                              100);
