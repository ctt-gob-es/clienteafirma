...
final class ProtocolInvocationLauncherErrorManager {
	...
	static final String ERROR_NO_CERTIFICATES = "SAF_10"; //$NON-NLS-1$
	...
	static final String ERROR_UNKNOWN_SIGNATURE = "SAF_17"; //$NON-NLS-1$
	static final String ERROR_DECODING_CERTIFICATE = "SAF_18"; //$NON-NLS-1$
	static final String ERROR_CERTIFICATE_MISSING = "SAF_19"; //$NON-NLS-1$
	...
	static {
		...
		ERRORS.put(ERROR_NO_CERTIFICATES, ProtocolMessages.getString("ProtocolLauncher.10")); //$NON-NLS-1$
		...
		ERRORS.put(ERROR_UNKNOWN_SIGNATURE, ProtocolMessages.getString("ProtocolLauncher.17")); //$NON-NLS-1$
		ERRORS.put(ERROR_DECODING_CERTIFICATE, ProtocolMessages.getString("ProtocolLauncher.18")); //$NON-NLS-1$
		ERRORS.put(ERROR_CERTIFICATE_MISSING, ProtocolMessages.getString("ProtocolLauncher.19")); //$NON-NLS-1$
