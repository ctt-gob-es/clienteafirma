...
public class SslSocketKeyStoreChecker extends SwingWorker<Void, Void>{

	private static final Logger LOGGER = Logger.getLogger("es.gob.afirma"); //$NON-NLS-1$

	private final Object parent;

	public SslSocketKeyStoreChecker(final Object parent) {
		this.parent = parent;
	}
    ...
    public Void doInBackground() {
    	...
    	try {
			...
			LOGGER.severe("No se ha encontrado el almacen de claves de Autofirma para la comunicacion por sockets"); //$NON-NLS-1$
