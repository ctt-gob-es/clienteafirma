...
public class HashDocumentFactory {
	...
	private static final String CLASS_HASHDOCUMENT_XML = "es.gob.afirma.standalone.ui.hash.XmlHashDocument"; //$NON-NLS-1$

	private static final String CLASS_HASHDOCUMENT_TXT = "es.gob.afirma.standalone.ui.hash.TxtHashDocument"; //$NON-NLS-1$

	private static final String CLASS_HASHDOCUMENT_CSV = "es.gob.afirma.standalone.ui.hash.CsvHashDocument"; //$NON-NLS-1$
