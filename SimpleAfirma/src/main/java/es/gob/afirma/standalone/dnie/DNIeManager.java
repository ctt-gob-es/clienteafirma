...
public final class DNIeManager {
	 ...
	 * @param pcl Clase a la que se notificar&aacute;n los eventos relacionados con la inserci&oacute;n y extracci&oacute;n de tarjetas en los lectores del sistema
     ...
     */
	 private static boolean itsDNIe(final byte[] atr) throws BlownDNIeException {
		...
		if (atr.length > 1 && 
			atr[atr.length-2] == (byte) 0x65 && 
		    atr[atr.length-1] == (byte) 0x81) 
		{
