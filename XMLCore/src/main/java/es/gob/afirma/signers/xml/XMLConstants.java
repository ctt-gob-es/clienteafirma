...
public final class XMLConstants {
    ...
    public static final Map<String, String> SIGN_ALGOS_URI = new HashMap<String, String>() {
        ...
        {
            put(AOSignConstants.SIGN_ALGORITHM_SHA1WITHRSA, "http://www.w3.org/2000/09/xmldsig#rsa-sha1");
            ...
            put(AOSignConstants.SIGN_ALGORITHM_MD5WITHRSA, "http://www.w3.org/2001/04/xmldsig-more#rsa-md5");
