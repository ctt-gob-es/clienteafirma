...
public final class TestCommitmentTypeIndications {
    ...
    static {
	    ...
	    p3.setProperty("commitmentTypeIndication0Identifier", "https://atos.net/content/dam/global/documents/we-are/atos-oracle-exadata-services.pdf"); //$NON-NLS-1$ //$NON-NLS-2$
	    p3.setProperty("commitmentTypeIndication0Qualifier", "1.2.3.4.5"); //$NON-NLS-1$ //$NON-NLS-2$
	    p3.setProperty("commitmentTypeIndication0Description", "Prueba"); //$NON-NLS-1$ //$NON-NLS-2$
	    p3.setProperty("commitmentTypeIndicationnDocumentationReferences", "http://es.atos.net/es-es/home.html|http://atos.net/en-us/home.html"); //$NON-NLS-1$ //$NON-NLS-2$
	    p3.setProperty("commitmentTypeIndicationnCommitmentTypeQualifiers", "Q1|Q2|Q3"); //$NON-NLS-1$ //$NON-NLS-2$
    }
