...
public class PdfFileSpecification extends PdfDictionary {
     ...
     * @since	2.1.3
     */
    private static PdfFileSpecification fileEmbedded(final PdfWriter writer, final String filePath, final String fileDisplay, final byte fileStore[], final int compressionLevel) throws IOException {
     ...
     */
    void addDescription(final String description, final boolean unicode) {
