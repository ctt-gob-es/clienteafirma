...
public class Base64 {
     ...
     * @since 2.1
     */
    private static byte[] decodeFromFile( final String filename ) {
     ...
     * @since 2.1
     */
    private static String encodeFromFile( final String filename ) {
        String encodedData = null;
        Base64.InputStream bis = null;
        try {
            // Set up some useful variables
            final java.io.File file = new java.io.File( filename );
            final byte[] buffer = new byte[ Math.max((int)(file.length() * 1.4),40) ]; // Need max() for math on small files (v2.2.1)
            int length   = 0;
            int numBytes = 0;
     ...
     * @since 2.2
     */
    private static void encodeFileToFile( final String infile, final String outfile ) {
     ...
     * @since 2.2
     */
    private static void decodeFileToFile( final String infile, final String outfile ) {
